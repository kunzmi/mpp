...
TEST_CASE("8uC1", "[CUDA.Arithmetic.And]")
{
    ...
    // Inplace
    cpu_src1.And(cpu_src2);
    gpu_src1.And(gpu_src2);
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.And.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.And.UnalignedPitch]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    gpu::Image<Pixel8uC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1Pitch.And(gpu_src2Pitch, gpu_dstPitch), PitchException);
}

TEST_CASE("8uC1", "[CUDA.Arithmetic.And.NullPtr]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.And(gpu_src2, gpu_dst), NullPtrException);
}

TEST_CASE("8uC1", "[CUDA.Arithmetic.And.Roi]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    gpu::Image<Pixel8uC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.And(gpu_src2, gpu_dst), RoiException);
}

TEST_CASE("8uC2", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.And.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.And.UnalignedPitch]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_src2(size, size);
    gpu::Image<Pixel8sC1> gpu_dst(size, size);
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.And.NullPtr]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_src2(size, size);
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.And.Roi]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_src2(size, size);
    gpu::Image<Pixel8sC1> gpu_dst(size, size);
...
TEST_CASE("8sC2", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Arithmetic.And]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
    ...
    // Inplace
    cpu_src1.And(constVal);
    gpu_src1.And(constVal);
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.AndC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
    ...
    cpu_src1.And(constVal, cpu_dst);
    gpu_src1.And(constDevVal, gpu_dst);
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.AndDevC]")
{
    const uint seed = Catch::getSeed();
