...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Add]")
{
    ...
    gpu_src1.Add(gpu_src2, gpu_dst, 2);
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Add.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Add.EvenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Add.UnalignedPitch]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    gpu::Image<Pixel8uC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1Pitch.Add(gpu_src2Pitch, gpu_dstPitch), PitchException);
}

TEST_CASE("8uC1", "[CUDA.Arithmetic.Add.NullPtr]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.Add(gpu_src2, gpu_dst), NullPtrException);
}

TEST_CASE("8uC1", "[CUDA.Arithmetic.Add.Roi]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    gpu::Image<Pixel8uC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.Add(gpu_src2, gpu_dst), RoiException);
}

TEST_CASE("8uC2", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
    ...
    // Inplace
    cpu_dst.Add(cpu_src2, cpu_dst, 1);
    gpu_dst.Add(gpu_src2, 1);
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC1", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC2", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC3", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC4", "[CUDA.Arithmetic.Add]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
    ...
    gpu_src1.Add(constVal, gpu_dst, 2);
    ...
    gpu_dst.Add(constVal, 1);

    gpu_res << gpu_dst;

    CHECK(cpu_dst.IsIdentical(gpu_res));

    cpu_src1.Add(constVal);
    gpu_src1.Add(constVal);
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC1", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC2", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC3", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC4", "[CUDA.Arithmetic.AddC]")
{
    const uint seed = Catch::getSeed();
    ...
    // Inplace
    cpu_dst.Add(constVal, 1);
    gpu_dst.Add(constVal, gpu_dst, 1);
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
    ...
    cpu_src1.Add(constVal, cpu_dst);
    gpu_src1.Add(constDevVal, gpu_dst);
    ...
    cpu_src1.Add(constVal, cpu_dst, 2);
    gpu_src1.Add(constDevVal, gpu_dst, 2);
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC1", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC2", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC3", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC4", "[CUDA.Arithmetic.AddDevC]")
{
    const uint seed = Catch::getSeed();
    ...
    // Inplace
    cpu_dst.Add(constVal, 1);
    gpu_dst.Add(constDevVal, gpu_dst, 1);
