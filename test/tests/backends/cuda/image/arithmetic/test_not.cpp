...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Not]")
{
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Not.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Not.UnalignedPitch]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1Pitch.Not(gpu_dstPitch), PitchException);
}

TEST_CASE("8sC1", "[CUDA.Arithmetic.Not.NullPtr]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);

    gpu::ImageView<Pixel8sC1> gpu_dst(nullptr, {{size, size}, gpu_src1.Pitch()});

    CHECK_THROWS_AS(gpu_src1.Not(gpu_dst), NullPtrException);
}

TEST_CASE("8sC1", "[CUDA.Arithmetic.Not.Roi]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.Not(gpu_dst), RoiException);
}

TEST_CASE("8sC2", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Arithmetic.Not]")
{
    const uint seed = Catch::getSeed();
