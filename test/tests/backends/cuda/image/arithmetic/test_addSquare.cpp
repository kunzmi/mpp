...
TEST_CASE("8uC1", "[CUDA.Arithmetic.AddSquare]")
{
    ...
    cpu_src1.AddSquare(cpu_dst);
    gpu_src1.AddSquare(gpu_dst);
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
    ...
    gpu_src1.AddSquareMasked(gpu_dst, gpu_mask);
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4A", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4A", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC1", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC2", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC3", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC4", "[CUDA.Arithmetic.AddSquare]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC1", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC2", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC3", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC4", "[CUDA.Arithmetic.AddSquareMasked]")
{
    const uint seed = Catch::getSeed();
