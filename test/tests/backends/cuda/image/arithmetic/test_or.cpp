...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Or]")
{
    ...
    // Inplace
    cpu_src1.Or(cpu_src2);
    gpu_src1.Or(gpu_src2);
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Or.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.Or.UnalignedPitch]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    gpu::Image<Pixel8uC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1Pitch.Or(gpu_src2Pitch, gpu_dstPitch), PitchException);
}

TEST_CASE("8uC1", "[CUDA.Arithmetic.Or.NullPtr]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.Or(gpu_src2, gpu_dst), NullPtrException);
}

TEST_CASE("8uC1", "[CUDA.Arithmetic.Or.Roi]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    gpu::Image<Pixel8uC1> gpu_dst(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.Or(gpu_src2, gpu_dst), RoiException);
}

TEST_CASE("8uC2", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Or.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Or.UnalignedPitch]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_src2(size, size);
    gpu::Image<Pixel8sC1> gpu_dst(size, size);
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Or.NullPtr]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_src2(size, size);
...
TEST_CASE("8sC1", "[CUDA.Arithmetic.Or.Roi]")
{
    gpu::Image<Pixel8sC1> gpu_src1(size, size);
    gpu::Image<Pixel8sC1> gpu_src2(size, size);
    gpu::Image<Pixel8sC1> gpu_dst(size, size);
...
TEST_CASE("8sC2", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Arithmetic.Or]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
    ...
    // Inplace
    cpu_src1.Or(constVal);
    gpu_src1.Or(constVal);
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.OrC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC2", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
    ...
    cpu_src1.Or(constVal, cpu_dst);
    gpu_src1.Or(constDevVal, gpu_dst);
...
TEST_CASE("8uC3", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Arithmetic.OrDevC]")
{
    const uint seed = Catch::getSeed();
