...
TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeError]")
{
    ...
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.AverageRelativeErrorBufferSize());
    ...
    gpu_src1.AverageRelativeError(gpu_src2, gpu_dst, gpu_buffer);
    gpu_dst >> gpu_res;

    cpu_src1.AverageRelativeError(cpu_src2, cpu_dst);

    CHECK(cpu_dst.x == Approx(gpu_res.x).margin(0.00001));
}

TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeError.BufferException]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    mpp::cuda::DevVar<Pixel64fC1> gpu_dst(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.AverageRelativeErrorBufferSize() / 2);

    CHECK_THROWS_AS(gpu_src1.AverageRelativeError(gpu_src2, gpu_dst, gpu_buffer), ScratchBufferException);
}

TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeError.ReducedRoi]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeError.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeError.NullPtr]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1.AverageRelativeError(gpu_src2Null, gpu_dst, gpu_buffer), NullPtrException);
    CHECK_THROWS_AS(gpu_src1.AverageRelativeError(gpu_src2, gpu_dst, gpu_bufferNull), NullPtrException);
}

TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeError.Roi]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    gpu::Image<Pixel8uC1> gpu_src2(size, size);
    mpp::cuda::DevVar<Pixel64fC1> gpu_dst(1);
    ...
    CHECK_THROWS_AS(gpu_src1.AverageRelativeError(gpu_src2, gpu_dst, gpu_buffer), RoiException);
}

TEST_CASE("8uC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
    ...
    gpu_src1.AverageRelativeError(gpu_src2, gpu_dst, gpu_dstScalar, gpu_buffer);
    gpu_dst >> gpu_res;
    gpu_dstScalar >> gpu_resScalar;

    cpu_src1.AverageRelativeError(cpu_src2, cpu_dst, cpu_dstScalar);
...
TEST_CASE("8uC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    ...
    Pixel64fC1 gpu_res;
    mpp::cuda::DevVar<Pixel64fC1> gpu_dst(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.AverageRelativeErrorMaskedBufferSize());
    ...
    gpu_src1.AverageRelativeErrorMasked(gpu_src2, gpu_dst, gpu_mask, gpu_buffer);
    gpu_dst >> gpu_res;

    cpu_src1.AverageRelativeErrorMasked(cpu_src2, cpu_dst, cpu_mask);

    CHECK(cpu_dst.x == Approx(gpu_res.x).margin(0.00001));
}

TEST_CASE("8uC1", "[CUDA.Statistics.AverageRelativeErrorMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
    ...
    gpu_src1.AverageRelativeErrorMasked(gpu_src2, gpu_dst, gpu_dstScalar, gpu_mask, gpu_buffer);
    gpu_dst >> gpu_res;
    gpu_dstScalar >> gpu_resScalar;

    cpu_src1.AverageRelativeErrorMasked(cpu_src2, cpu_dst, cpu_dstScalar, cpu_mask);
...
TEST_CASE("8uC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4A", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC4A", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16scC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16scC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16scC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16scC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16scC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32scC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32scC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32scC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32scC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32scC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fcC1", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC2", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC3", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC4", "[CUDA.Statistics.AverageRelativeError]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fcC1", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fcC2", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fcC3", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fcC4", "[CUDA.Statistics.AverageRelativeErrorMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
