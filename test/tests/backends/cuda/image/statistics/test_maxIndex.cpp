...
TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndex]")
{
    ...
    Pixel32sC1 cpu_dstIndexX;
    Pixel32sC1 cpu_dstIndexY;
    Pixel8uC1 gpu_resMax;
    Pixel32sC1 gpu_resIndexX;
    Pixel32sC1 gpu_resIndexY;
    mpp::cuda::DevVar<Pixel8uC1> gpu_dstMax(1);
    mpp::cuda::DevVar<Pixel32sC1> gpu_dstIndexX(1);
    mpp::cuda::DevVar<Pixel32sC1> gpu_dstIndexY(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MaxIndexBufferSize());

    cpu_src1.FillRandom(seed);
    cpu_src1 >> gpu_src1;

    gpu_src1.MaxIndex(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_buffer);
    gpu_dstMax >> gpu_resMax;
    gpu_dstIndexX >> gpu_resIndexX;
    gpu_dstIndexY >> gpu_resIndexY;

    cpu_src1.MaxIndex(cpu_dstMax, cpu_dstIndexX, cpu_dstIndexY);

    CHECK(cpu_dstMax == gpu_resMax);
    CHECK(cpu_dstIndexX == gpu_resIndexX);
    CHECK(cpu_dstIndexY == gpu_resIndexY);
}

TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndex.BufferException]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    ...
    mpp::cuda::DevVar<Pixel32sC1> gpu_dstIndexX(1);
    mpp::cuda::DevVar<Pixel32sC1> gpu_dstIndexY(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MaxIndexBufferSize() / 2);

    CHECK_THROWS_AS(gpu_src1.MaxIndex(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_buffer), ScratchBufferException);
}

TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndex.ReducedRoi]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndex.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndex.NullPtr]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1Null.MaxIndex(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_buffer), NullPtrException);
    CHECK_THROWS_AS(gpu_src1.MaxIndex(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_bufferNull), NullPtrException);
}

TEST_CASE("8uC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
    ...
    Pixel32sC2 cpu_dstIndexX;
    Pixel32sC2 cpu_dstIndexY;
    byte cpu_dstMaxScalar;

    Pixel32sC3 cpu_dstIndexScalar;
    Pixel8uC2 gpu_resMax;
    Pixel32sC2 gpu_resIndexX;
    Pixel32sC2 gpu_resIndexY;
    byte gpu_resMaxScalar;
    Pixel32sC3 gpu_resIndexScalar;
    mpp::cuda::DevVar<Pixel8uC2> gpu_dstMax(1);
    mpp::cuda::DevVar<Pixel32sC2> gpu_dstIndexX(1);
    mpp::cuda::DevVar<Pixel32sC2> gpu_dstIndexY(1);
    mpp::cuda::DevVar<byte> gpu_dstMaxScalar(1);
    mpp::cuda::DevVar<Pixel32sC3> gpu_dstIndexScalar(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MaxIndexBufferSize());
    ...
    gpu_src1.MaxIndex(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_dstMaxScalar, gpu_dstIndexScalar, gpu_buffer);
    gpu_dstMax >> gpu_resMax;
    gpu_dstIndexX >> gpu_resIndexX;
    gpu_dstIndexY >> gpu_resIndexY;
    ...
    cpu_src1.MaxIndex(cpu_dstMax, cpu_dstIndexX, cpu_dstIndexY, cpu_dstMaxScalar, cpu_dstIndexScalar);

    CHECK(cpu_dstMax == gpu_resMax);
    CHECK(cpu_dstIndexX == gpu_resIndexX);
    CHECK(cpu_dstIndexY == gpu_resIndexY);
    CHECK(cpu_dstMaxScalar == gpu_resMaxScalar);
    CHECK(cpu_dstIndexScalar == gpu_resIndexScalar);
}

TEST_CASE("8uC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
    ...
    Pixel32sC3 cpu_dstIndexX;
    Pixel32sC3 cpu_dstIndexY;
    byte cpu_dstMaxScalar;

    Pixel32sC3 cpu_dstIndexScalar;
    Pixel8uC3 gpu_resMax;
    Pixel32sC3 gpu_resIndexX;
    Pixel32sC3 gpu_resIndexY;
    byte gpu_resMaxScalar;
    Pixel32sC3 gpu_resIndexScalar;
    mpp::cuda::DevVar<Pixel8uC3> gpu_dstMax(1);
    mpp::cuda::DevVar<Pixel32sC3> gpu_dstIndexX(1);
    mpp::cuda::DevVar<Pixel32sC3> gpu_dstIndexY(1);
    mpp::cuda::DevVar<byte> gpu_dstMaxScalar(1);
    mpp::cuda::DevVar<Pixel32sC3> gpu_dstIndexScalar(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MaxIndexBufferSize());
...
TEST_CASE("8uC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
    ...
    Pixel32sC4 cpu_dstIndexX;
    Pixel32sC4 cpu_dstIndexY;
    byte cpu_dstMaxScalar;

    Pixel32sC3 cpu_dstIndexScalar;
    Pixel8uC4 gpu_resMax;
    Pixel32sC4 gpu_resIndexX;
    Pixel32sC4 gpu_resIndexY;
    byte gpu_resMaxScalar;
    Pixel32sC3 gpu_resIndexScalar;
    mpp::cuda::DevVar<Pixel8uC4> gpu_dstMax(1);
    mpp::cuda::DevVar<Pixel32sC4> gpu_dstIndexX(1);
    mpp::cuda::DevVar<Pixel32sC4> gpu_dstIndexY(1);
    mpp::cuda::DevVar<byte> gpu_dstMaxScalar(1);
    mpp::cuda::DevVar<Pixel32sC3> gpu_dstIndexScalar(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MaxIndexBufferSize());
...
TEST_CASE("8uC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
    ...
    Pixel32sC4A cpu_dstIndexX;
    Pixel32sC4A cpu_dstIndexY;
    byte cpu_dstMaxScalar;

    Pixel32sC3 cpu_dstIndexScalar;
    Pixel8uC4A gpu_resMax;
    Pixel32sC4A gpu_resIndexX;
    Pixel32sC4A gpu_resIndexY;
    byte gpu_resMaxScalar;
    Pixel32sC3 gpu_resIndexScalar;
    mpp::cuda::DevVar<Pixel8uC4A> gpu_dstMax(1);
    mpp::cuda::DevVar<Pixel32sC4A> gpu_dstIndexX(1);
    mpp::cuda::DevVar<Pixel32sC4A> gpu_dstIndexY(1);
    mpp::cuda::DevVar<byte> gpu_dstMaxScalar(1);
    mpp::cuda::DevVar<Pixel32sC3> gpu_dstIndexScalar(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MaxIndexBufferSize());
...
TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    ...
    gpu_src1.MaxIndexMasked(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_mask, gpu_buffer);
    gpu_dstMax >> gpu_resMax;
    gpu_dstIndexX >> gpu_resIndexX;
    gpu_dstIndexY >> gpu_resIndexY;

    cpu_src1.MaxIndexMasked(cpu_dstMax, cpu_dstIndexX, cpu_dstIndexY, cpu_mask);
...
TEST_CASE("8uC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
    ...
    gpu_src1.MaxIndexMasked(gpu_dstMax, gpu_dstIndexX, gpu_dstIndexY, gpu_dstMaxScalar, gpu_dstIndexScalar, gpu_mask,
                            gpu_buffer);
    gpu_dstMax >> gpu_resMax;
    gpu_dstIndexX >> gpu_resIndexX;
    gpu_dstIndexY >> gpu_resIndexY;
    ...
    cpu_src1.MaxIndexMasked(cpu_dstMax, cpu_dstIndexX, cpu_dstIndexY, cpu_dstMaxScalar, cpu_dstIndexScalar, cpu_mask);
...
TEST_CASE("8uC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch ::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC1", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC2", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC3", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4A", "[CUDA.Statistics.MaxIndex]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC1", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC1", "[CUDA.Statistics.MaxIndexMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC2", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC3", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC4", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC4A", "[CUDA.Statistics.MaxIndexMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
