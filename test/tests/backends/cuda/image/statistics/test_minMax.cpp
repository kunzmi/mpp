...
TEST_CASE("8uC1", "[CUDA.Statistics.MinMax]")
{
    ...
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MinMaxBufferSize());

    cpu_src1.FillRandom(seed);
    cpu_src1 >> gpu_src1;

    gpu_src1.MinMax(gpu_dstMin, gpu_dstMax, gpu_buffer);
...
TEST_CASE("8uC1", "[CUDA.Statistics.MinMax.BufferException]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    mpp::cuda::DevVar<Pixel8uC1> gpu_dstMin(1);
    mpp::cuda::DevVar<Pixel8uC1> gpu_dstMax(1);
    mpp::cuda::DevVar<byte> gpu_buffer(gpu_src1.MinMaxBufferSize() / 2);

    CHECK_THROWS_AS(gpu_src1.MinMax(gpu_dstMin, gpu_dstMax, gpu_buffer), ScratchBufferException);
}

TEST_CASE("8uC1", "[CUDA.Statistics.MinMax.ReducedRoi]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.MinMax.UnevenSizeAlloc]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.MinMax.NullPtr]")
{
    gpu::Image<Pixel8uC1> gpu_src1(size, size);
    ...
    CHECK_THROWS_AS(gpu_src1Null.MinMax(gpu_dstMin, gpu_dstMax, gpu_buffer), NullPtrException);
    CHECK_THROWS_AS(gpu_src1.MinMax(gpu_dstMin, gpu_dstMax, gpu_bufferNull), NullPtrException);
}

TEST_CASE("8uC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
    ...
    gpu_src1.MinMax(gpu_dstMin, gpu_dstMax, gpu_dstMinScalar, gpu_dstMaxScalar, gpu_buffer);
    gpu_dstMin >> gpu_resMin;
    gpu_dstMax >> gpu_resMax;
    gpu_dstMinScalar >> gpu_resMinScalar;
    gpu_dstMaxScalar >> gpu_resMaxScalar;

    cpu_src1.MinMax(cpu_dstMin, cpu_dstMax, cpu_dstMinScalar, cpu_dstMaxScalar);
...
TEST_CASE("8uC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8uC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    ...
    gpu_src1.MinMaxMasked(gpu_dstMin, gpu_dstMax, gpu_mask, gpu_buffer);
    gpu_dstMin >> gpu_resMin;
    gpu_dstMax >> gpu_resMax;

    cpu_src1.MinMaxMasked(cpu_dstMin, cpu_dstMax, cpu_mask);

    CHECK(cpu_dstMin == gpu_resMin);
    CHECK(cpu_dstMax == gpu_resMax);
}

TEST_CASE("8uC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
    ...
    gpu_src1.MinMaxMasked(gpu_dstMin, gpu_dstMax, gpu_dstMinScalar, gpu_dstMaxScalar, gpu_mask, gpu_buffer);
    gpu_dstMin >> gpu_resMin;
    gpu_dstMax >> gpu_resMax;
    gpu_dstMinScalar >> gpu_resMinScalar;
    gpu_dstMaxScalar >> gpu_resMaxScalar;

    cpu_src1.MinMaxMasked(cpu_dstMin, cpu_dstMax, cpu_dstMinScalar, cpu_dstMaxScalar, cpu_mask);
...
TEST_CASE("8uC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8uC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("8sC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("8sC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch ::getSeed();
...
TEST_CASE("16uC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16uC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16uC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16sC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16sC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32uC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32uC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32sC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32sC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16fC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16fC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("16bfC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("16bfC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("32fC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("32fC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC1", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC2", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC3", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC4A", "[CUDA.Statistics.MinMax]")
{
    const uint seed = Catch::getSeed();
...
TEST_CASE("64fC1", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC1", "[CUDA.Statistics.MinMaxMasked.ReducedRoi]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC2", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC3", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC4", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
...
TEST_CASE("64fC4A", "[CUDA.Statistics.MinMaxMasked]")
{
    const uint seed                  = Catch::getSeed();
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    cpu::Image<Pixel8uC1> cpu_mask   = cpu::Image<Pixel8uC1>::Load(root / "maskAllSizes.tif");
