...
TEST_CASE("8uC1", "[NPP.Statistics.ThresholdLtGtVal]")
{
    ...
    npp_src1.Threshold_LTValGTVal(npp_dst, 100, 1, 200, 254, nppCtx);
    npp_res << npp_dst;

    cpu_src1.ThresholdLTGT(100, 1, 200, 254, cpu_dst);

    CHECK(cpu_dst.IsIdentical(npp_res));

    npp_src1.Threshold_LTValGTVal(100, 1, 200, 254, nppCtx);
    npp_res << npp_src1;

    cpu_src1.ThresholdLTGT(100, 1, 200, 254);

    CHECK(cpu_src1.IsIdentical(npp_res));
}

TEST_CASE("8uC3", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    ...
    npp_src1.Threshold_LTValGTVal(npp_dst, {100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253}, nppCtx);
    npp_res << npp_dst;

    cpu_src1.ThresholdLTGT({100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253}, cpu_dst);

    CHECK(cpu_dst.IsIdentical(npp_res));

    npp_src1.Threshold_LTValGTVal({100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253}, nppCtx);
    npp_res << npp_src1;

    cpu_src1.ThresholdLTGT({100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253});

    CHECK(cpu_src1.IsIdentical(npp_res));
}

TEST_CASE("8uC4A", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC3::GetStreamContext();
    ...
    npp_src1.Threshold_LTValGTValA(npp_dst, {100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253}, nppCtx);
    npp_res << npp_dst;

    cpu_src1A.ThresholdLTGT({100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253}, cpu_dstA);

    CHECK(cpu_dst.IsIdentical(npp_res));

    npp_src1.Threshold_LTValGTValA({100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253}, nppCtx);
    npp_res << npp_src1;

    cpu_src1A.ThresholdLTGT({100, 101, 102}, {1, 2, 3}, {200, 201, 202}, {251, 252, 253});

    CHECK(cpu_src1.IsIdentical(npp_res));
}

TEST_CASE("16sC1", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC4A", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC3::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4A", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC3::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    ...
    npp_src1.Threshold_LTValGTVal(npp_dst, 0.2f, 0.1f, 0.8f, 0.9f, nppCtx);
    npp_res << npp_dst;

    cpu_src1.ThresholdLTGT(0.2f, 0.1f, 0.8f, 0.9f, cpu_dst);

    CHECK(cpu_dst.IsIdentical(npp_res));

    npp_src1.Threshold_LTValGTVal(0.2f, 0.1f, 0.8f, 0.9f, nppCtx);
    npp_res << npp_src1;

    cpu_src1.ThresholdLTGT(0.2f, 0.1f, 0.8f, 0.9f);

    CHECK(cpu_src1.IsIdentical(npp_res));
}

TEST_CASE("32fC3", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    ...
    npp_src1.Threshold_LTValGTVal(npp_dst, {0.2f, 0.21f, 0.22f}, {0.1f, 0.12f, 0.13f}, {0.8f, 0.81f, 0.82f},
                                  {0.91f, 0.92f, 0.93f}, nppCtx);
    npp_res << npp_dst;

    cpu_src1.ThresholdLTGT({0.2f, 0.21f, 0.22f}, {0.1f, 0.12f, 0.13f}, {0.8f, 0.81f, 0.82f}, {0.91f, 0.92f, 0.93f},
                           cpu_dst);

    CHECK(cpu_dst.IsIdentical(npp_res));

    npp_src1.Threshold_LTValGTVal({0.2f, 0.21f, 0.22f}, {0.1f, 0.12f, 0.13f}, {0.8f, 0.81f, 0.82f},
                                  {0.91f, 0.92f, 0.93f}, nppCtx);
    npp_res << npp_src1;
...
TEST_CASE("32fC4A", "[NPP.Statistics.ThresholdLtGtVal]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC3::GetStreamContext();
    ...
    npp_src1.Threshold_LTValGTValA(npp_dst, {0.2f, 0.21f, 0.22f}, {0.1f, 0.12f, 0.13f}, {0.8f, 0.81f, 0.82f},
                                   {0.91f, 0.92f, 0.93f}, nppCtx);
    npp_res << npp_dst;

    cpu_src1A.ThresholdLTGT({0.2f, 0.21f, 0.22f}, {0.1f, 0.12f, 0.13f}, {0.8f, 0.81f, 0.82f}, {0.91f, 0.92f, 0.93f},
                            cpu_dstA);

    CHECK(cpu_dst.IsIdentical(npp_res));

    npp_src1.Threshold_LTValGTValA({0.2f, 0.21f, 0.22f}, {0.1f, 0.12f, 0.13f}, {0.8f, 0.81f, 0.82f},
                                   {0.91f, 0.92f, 0.93f}, nppCtx);
    npp_res << npp_src1;
