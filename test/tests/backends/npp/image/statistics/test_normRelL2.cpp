...
TEST_CASE("8uC1", "[NPP.Statistics.NormRelL2]")
{
    ...
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.NormRelL2GetBufferHostSize(nppCtx));
...
TEST_CASE("8uC1", "[NPP.Statistics.NormRelL2Masked]")
{
    ...
    nv::Image8uC1 npp_src2(size, size);
    mpp::cuda::DevVar<double> npp_dst(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.NormRelL2GetBufferHostSizeMasked(nppCtx));
