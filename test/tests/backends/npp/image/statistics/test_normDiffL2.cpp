...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffL2]")
{
    ...
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffL2GetBufferHostSize(nppCtx));
...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffL2Masked]")
{
    ...
    nv::Image8uC1 npp_src2(size, size);
    mpp::cuda::DevVar<double> npp_dst(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffL2GetBufferHostSizeMasked(nppCtx));
