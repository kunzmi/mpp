...
TEST_CASE("8uC1", "[NPP.Statistics.Max]")
{
    ...
    npp_src1.Max(npp_buffer, npp_dst, nppCtx);
    npp_dst >> npp_res;

    cpu_src1.Max(cpu_dst);

    CHECK(cpu_dst.x == npp_res);
}

TEST_CASE("8uC3", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    cpu_src1.Max(cpu_dst, cpu_dstScalar);
...
TEST_CASE("8uC4", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC4", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4A", "[NPP.Statistics.Max]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
    ...
    npp_src1.MaxA(npp_buffer, npp_dst, nppCtx);
    npp_dst >> npp_res;

    cpu_src1A.Max(cpu_dst, cpu_dstScalar);
