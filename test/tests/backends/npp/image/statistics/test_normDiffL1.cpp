...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffL1]")
{
    ...
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffL1GetBufferHostSize(nppCtx));
...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffL1Masked]")
{
    ...
    nv::Image8uC1 npp_src2(size, size);
    opp::cuda::DevVar<double> npp_dst(1);
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffL1GetBufferHostSizeMasked(nppCtx));
