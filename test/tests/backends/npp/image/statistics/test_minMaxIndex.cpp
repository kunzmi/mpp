...
TEST_CASE("8uC1", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<byte> npp_dstMin(1);
    mpp::cuda::DevVar<byte> npp_dstMax(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("8uC3", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<byte> npp_dstMin(3);
    mpp::cuda::DevVar<byte> npp_dstMax(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(3);
    mpp::cuda::DevVarView<byte> npp_dstMin1(npp_dstMin.Pointer() + 0, sizeof(byte));
    mpp::cuda::DevVarView<byte> npp_dstMax1(npp_dstMax.Pointer() + 0, sizeof(byte));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin1(npp_dstIdxMin.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax1(npp_dstIdxMax.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<byte> npp_dstMin2(npp_dstMin.Pointer() + 1, sizeof(byte));
    mpp::cuda::DevVarView<byte> npp_dstMax2(npp_dstMax.Pointer() + 1, sizeof(byte));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin2(npp_dstIdxMin.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax2(npp_dstIdxMax.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<byte> npp_dstMin3(npp_dstMin.Pointer() + 2, sizeof(byte));
    mpp::cuda::DevVarView<byte> npp_dstMax3(npp_dstMax.Pointer() + 2, sizeof(byte));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin3(npp_dstIdxMin.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax3(npp_dstIdxMax.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("8sC1", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<sbyte> npp_dstMin(1);
    mpp::cuda::DevVar<sbyte> npp_dstMax(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("8sC3", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<sbyte> npp_dstMin(3);
    mpp::cuda::DevVar<sbyte> npp_dstMax(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(3);
    mpp::cuda::DevVarView<sbyte> npp_dstMin1(npp_dstMin.Pointer() + 0, sizeof(sbyte));
    mpp::cuda::DevVarView<sbyte> npp_dstMax1(npp_dstMax.Pointer() + 0, sizeof(sbyte));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin1(npp_dstIdxMin.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax1(npp_dstIdxMax.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<sbyte> npp_dstMin2(npp_dstMin.Pointer() + 1, sizeof(sbyte));
    mpp::cuda::DevVarView<sbyte> npp_dstMax2(npp_dstMax.Pointer() + 1, sizeof(sbyte));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin2(npp_dstIdxMin.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax2(npp_dstIdxMax.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<sbyte> npp_dstMin3(npp_dstMin.Pointer() + 2, sizeof(sbyte));
    mpp::cuda::DevVarView<sbyte> npp_dstMax3(npp_dstMax.Pointer() + 2, sizeof(sbyte));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin3(npp_dstIdxMin.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax3(npp_dstIdxMax.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("16uC1", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<ushort> npp_dstMin(1);
    mpp::cuda::DevVar<ushort> npp_dstMax(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("16uC3", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<ushort> npp_dstMin(3);
    mpp::cuda::DevVar<ushort> npp_dstMax(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(3);
    mpp::cuda::DevVarView<ushort> npp_dstMin1(npp_dstMin.Pointer() + 0, sizeof(ushort));
    mpp::cuda::DevVarView<ushort> npp_dstMax1(npp_dstMax.Pointer() + 0, sizeof(ushort));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin1(npp_dstIdxMin.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax1(npp_dstIdxMax.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<ushort> npp_dstMin2(npp_dstMin.Pointer() + 1, sizeof(ushort));
    mpp::cuda::DevVarView<ushort> npp_dstMax2(npp_dstMax.Pointer() + 1, sizeof(ushort));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin2(npp_dstIdxMin.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax2(npp_dstIdxMax.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<ushort> npp_dstMin3(npp_dstMin.Pointer() + 2, sizeof(ushort));
    mpp::cuda::DevVarView<ushort> npp_dstMax3(npp_dstMax.Pointer() + 2, sizeof(ushort));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin3(npp_dstIdxMin.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax3(npp_dstIdxMax.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("32fC1", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<float> npp_dstMin(1);
    mpp::cuda::DevVar<float> npp_dstMax(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(1);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
...
TEST_CASE("32fC3", "[NPP.Statistics.MinMaxIndex]")
{
    ...
    mpp::cuda::DevVar<float> npp_dstMin(3);
    mpp::cuda::DevVar<float> npp_dstMax(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMin(3);
    mpp::cuda::DevVar<NppiPoint> npp_dstIdxMax(3);
    mpp::cuda::DevVarView<float> npp_dstMin1(npp_dstMin.Pointer() + 0, sizeof(float));
    mpp::cuda::DevVarView<float> npp_dstMax1(npp_dstMax.Pointer() + 0, sizeof(float));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin1(npp_dstIdxMin.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax1(npp_dstIdxMax.Pointer() + 0, sizeof(NppiPoint));
    mpp::cuda::DevVarView<float> npp_dstMin2(npp_dstMin.Pointer() + 1, sizeof(float));
    mpp::cuda::DevVarView<float> npp_dstMax2(npp_dstMax.Pointer() + 1, sizeof(float));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin2(npp_dstIdxMin.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax2(npp_dstIdxMax.Pointer() + 1, sizeof(NppiPoint));
    mpp::cuda::DevVarView<float> npp_dstMin3(npp_dstMin.Pointer() + 2, sizeof(float));
    mpp::cuda::DevVarView<float> npp_dstMax3(npp_dstMax.Pointer() + 2, sizeof(float));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMin3(npp_dstIdxMin.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVarView<NppiPoint> npp_dstIdxMax3(npp_dstIdxMax.Pointer() + 2, sizeof(NppiPoint));
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.MinMaxIndxGetBufferHostSize(nppCtx));
