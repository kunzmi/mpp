...
TEST_CASE("8uC1", "[NPP.Statistics.NormInf]")
{
    ...
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.NormInfGetBufferHostSize(nppCtx));

    cpu_src1.FillRandomNormal(seed, 127, 10);

    cpu_src1 >> npp_src1;

    npp_src1.Norm_Inf(npp_dst, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC3", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC4", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC1", "[NPP.Statistics.NormInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    nv::Image8uC1 npp_src1(size, size);
    opp::cuda::DevVar<double> npp_dst(1);
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.NormInfGetBufferHostSizeMasked(nppCtx));
    ...
    npp_src1.Norm_Inf(npp_mask, npp_dst, npp_buffer, nppCtx);
    npp_dst >> npp_res;

    cpu_src1.NormInfMasked(cpu_dst, cpu_mask);
    // due to bug in NPP, verify CPU with Max(), which should be the same for unsigned char:
    cpu_src1.MaxMasked(cpu_dstMax, cpu_mask);

    // BUG in NPP, NPP doesn't always find the maximum...
    // CHECK(cpu_dst.x == Approx(npp_res).margin(0.00001));
    CHECK(cpu_dst.x == cpu_dstMax.x);
}

TEST_CASE("8uC3", "[NPP.Statistics.NormInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    npp_src1.Norm_Inf(npp_mask, 1, npp_dst1, npp_buffer, nppCtx);
    npp_src1.Norm_Inf(npp_mask, 2, npp_dst2, npp_buffer, nppCtx);
    npp_src1.Norm_Inf(npp_mask, 3, npp_dst3, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8sC1", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    ...
    cpu_src1.FillRandomNormal(seed, 0, 20);
...
TEST_CASE("8sC3", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    ...
    cpu_src1.FillRandomNormal(seed, 16000, 1000);
...
TEST_CASE("16uC3", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.NormInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC3", "[NPP.Statistics.NormInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC4", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("32sC1", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Statistics.NormInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.NormInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC3", "[NPP.Statistics.NormInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
