...
TEST_CASE("8uC1", "[NPP.Statistics.SqrDistance]")
{
    ...
    npp_src1.SqrDistanceValid_Norm(npp_tpl, npp_dst, nppCtx);
    npp_res << npp_dst;
    ...
    npp_dst.Set(0, nppCtx);
    npp_src1.SqrDistanceSame_Norm(npp_tpl, npp_dst, nppCtx);
    npp_res << npp_dst;
...
TEST_CASE("16uC1", "[NPP.Statistics.SqrDistance]")
{
    // const uint seed            = Catch::getSeed();
    NppStreamContext nppCtx    = nv::Image8uC1::GetStreamContext();
    std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
...
TEST_CASE("32fC1", "[NPP.Statistics.SqrDistance]")
{
    // const uint seed            = Catch::getSeed();
    NppStreamContext nppCtx    = nv::Image8uC1::GetStreamContext();
    std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
