...
TEST_CASE("8uC1", "[NPP.Statistics.DotProduct]")
{
    ...
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.DotProdGetBufferHostSize(nppCtx));
    ...
    npp_src1.DotProd(npp_src2, npp_dst, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8sC1", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8sC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("8sC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("32uC1", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32uC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32uC1::GetStreamContext();
...
TEST_CASE("32uC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32uC1::GetStreamContext();
...
TEST_CASE("32sC1", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32sC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC1::GetStreamContext();
...
TEST_CASE("32sC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Statistics.DotProduct]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
