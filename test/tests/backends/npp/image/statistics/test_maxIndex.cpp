...
TEST_CASE("8uC1", "[NPP.Statistics.MaxIndex]")
{
    ...
    npp_src1.MaxIndx(npp_buffer, npp_dst, npp_dstIdxX, npp_dstIdxY, nppCtx);
    npp_dst >> npp_res;
    npp_dstIdxX >> npp_idxX.data();
    npp_dstIdxY >> npp_idxY.data();

    cpu_src1.MaxIndex(cpu_dst, cpu_idxX, cpu_idxY);

    CHECK(cpu_src1(cpu_idxX.x, cpu_idxY.x) == 200);
...
TEST_CASE("8uC3", "[NPP.Statistics.MaxIndex]")
{
    ...
    cpu_src1(100, 10) = {200, 201, 202};
    cpu_src1(104, 10) = {200, 201, 202};
    cpu_src1(10, 100) = {200, 201, 202};
    cpu_src1(9, 120)  = {200, 201, 202};
    ...
    cpu_src1.MaxIndex(cpu_dst, cpu_idxX, cpu_idxY, cpu_dstScalar, cpu_IdxScalar);

    CHECK(cpu_src1(cpu_idxX.x, cpu_idxY.x).x == 200);
    CHECK(cpu_idxX.x == 100);
    CHECK(cpu_idxY.x == 10);
    CHECK(cpu_src1(cpu_idxX.y, cpu_idxY.y).y == 201);
    CHECK(cpu_idxX.y == 100);
    CHECK(cpu_idxY.y == 10);
    CHECK(cpu_src1(cpu_idxX.z, cpu_idxY.z).z == 202);
    ...
    CHECK(cpu_idxY.x == npp_idxY.x);
    CHECK(cpu_src1(npp_idxX.x, npp_idxY.x) == 200);*/
    CHECK(cpu_dstScalar == std::max({npp_res[0], npp_res[1], npp_res[2]}));
    CHECK(cpu_dst.x == npp_res[0]);
    CHECK(cpu_dst.y == npp_res[1]);
    CHECK(cpu_dst.z == npp_res[2]);
}

TEST_CASE("8uC4", "[NPP.Statistics.MaxIndex]")
{
    ...
    cpu_src1(100, 10) = {200, 201, 202, 203};
    cpu_src1(104, 10) = {200, 201, 202, 203};
    cpu_src1(10, 100) = {200, 201, 202, 203};
    cpu_src1(9, 120)  = {200, 201, 202, 203};
    ...
    CHECK(cpu_idxX.z == 100);
    CHECK(cpu_idxY.z == 10);
    CHECK(cpu_src1(cpu_idxX.w, cpu_idxY.w).w == 203);
    ...
    CHECK(cpu_idxY.x == npp_idxY.x);
    CHECK(cpu_src1(npp_idxX.x, npp_idxY.x) == 200);*/
    CHECK(cpu_dstScalar == std::max({npp_res[0], npp_res[1], npp_res[2], npp_res[3]}));
    CHECK(cpu_dst.x == npp_res[0]);
    CHECK(cpu_dst.y == npp_res[1]);
    CHECK(cpu_dst.z == npp_res[2]);
...
TEST_CASE("8uC4A", "[NPP.Statistics.MaxIndex]")
{
    NppStreamContext nppCtx = nv::Image8uC4::GetStreamContext();
    ...
    cpu_src1A(100, 10) = {200, 201, 202};
    cpu_src1A(104, 10) = {200, 201, 202};
    cpu_src1A(10, 100) = {200, 201, 202};
    cpu_src1A(9, 120)  = {200, 201, 202};

    cpu_src1 >> npp_src1;

    npp_src1.MaxIndxA(npp_buffer, npp_dst, npp_dstIdxX, npp_dstIdxY, nppCtx);
    npp_dst >> npp_res;
    npp_dstIdxX >> npp_idxX.data();
    npp_dstIdxY >> npp_idxY.data();

    cpu_src1A.MaxIndex(cpu_dst, cpu_idxX, cpu_idxY, cpu_dstScalar, cpu_IdxScalar);
...
TEST_CASE("16sC1", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("16sC3", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("16sC4", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("16sC4A", "[NPP.Statistics.MaxIndex]")
{
    NppStreamContext nppCtx = nv::Image16sC4::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("16uC3", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("16uC4", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("16uC4A", "[NPP.Statistics.MaxIndex]")
{
    NppStreamContext nppCtx = nv::Image16uC4::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("32fC3", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("32fC4", "[NPP.Statistics.MaxIndex]")
{
...
TEST_CASE("32fC4A", "[NPP.Statistics.MaxIndex]")
{
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
