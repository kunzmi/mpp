...
TEST_CASE("8uC1", "[NPP.Statistics.MaxEvery]")
{
    ...
    npp_srcdst.MaxEvery(npp_src2, nppCtx);
    npp_res << npp_srcdst;

    cpu_srcdst.MaxEvery(cpu_src2);

    CHECK(cpu_srcdst.IsIdentical(npp_res));
}

TEST_CASE("8uC3", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4A", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC4::GetStreamContext();
    ...
    npp_srcdst.MaxEveryA(npp_src2, nppCtx);
    npp_res << npp_srcdst;

    cpu_srcdstA.MaxEvery(cpu_src2A);

    CHECK(cpu_srcdst.IsIdentical(npp_res));
}

TEST_CASE("16uC1", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4A", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC4::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC4", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC4A", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC4::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4A", "[NPP.Statistics.MaxEvery]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
