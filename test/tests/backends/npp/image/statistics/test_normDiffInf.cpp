...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffInf]")
{
    ...
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffInfGetBufferHostSize(nppCtx));
    ...
    npp_src1.NormDiff_Inf(npp_src2, npp_dst, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC3", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC4", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    nv::Image8uC1 npp_src2(size, size);
    mpp::cuda::DevVar<double> npp_dst(1);
    mpp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffInfGetBufferHostSizeMasked(nppCtx));
    ...
    npp_src1.NormDiff_Inf(npp_src2, npp_mask, npp_dst, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC3", "[NPP.Statistics.NormDiffInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    npp_src1.NormDiff_Inf(npp_src2, npp_mask, 1, npp_dst1, npp_buffer, nppCtx);
    npp_src1.NormDiff_Inf(npp_src2, npp_mask, 2, npp_dst2, npp_buffer, nppCtx);
    npp_src1.NormDiff_Inf(npp_src2, npp_mask, 3, npp_dst3, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8sC1", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8sC3", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.NormDiffInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC3", "[NPP.Statistics.NormDiffInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC4", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Statistics.NormDiffInf]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.NormDiffInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC3", "[NPP.Statistics.NormDiffInfMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
