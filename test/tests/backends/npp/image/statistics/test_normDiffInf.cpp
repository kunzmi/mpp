...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffInf]")
{
    ...
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffInfGetBufferHostSize(nppCtx));
...
TEST_CASE("8uC1", "[NPP.Statistics.NormDiffInfMasked]")
{
    ...
    nv::Image8uC1 npp_src2(size, size);
    opp::cuda::DevVar<double> npp_dst(1);
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.NormDiffInfGetBufferHostSizeMasked(nppCtx));
