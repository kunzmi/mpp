...
TEST_CASE("8uC1", "[NPP.Statistics.MaximumError]")
{
    ...
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.MaximumErrorGetBufferHostSize(nppCtx));
    ...
    npp_src1.MaximumError(npp_src2, npp_dst, npp_buffer, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8sC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8sC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("8sC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("8sC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16scC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16scC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16scC1::GetStreamContext();
...
TEST_CASE("16scC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16scC1::GetStreamContext();
...
TEST_CASE("16scC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16scC1::GetStreamContext();
...
TEST_CASE("32uC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32uC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32uC1::GetStreamContext();
...
TEST_CASE("32uC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32uC1::GetStreamContext();
...
TEST_CASE("32uC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32uC1::GetStreamContext();
...
TEST_CASE("32sC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32sC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC1::GetStreamContext();
...
TEST_CASE("32sC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC1::GetStreamContext();
...
TEST_CASE("32sC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC1::GetStreamContext();
...
TEST_CASE("32scC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32scC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32scC1::GetStreamContext();
...
TEST_CASE("32scC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32scC1::GetStreamContext();
...
TEST_CASE("32scC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32scC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fcC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fcC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fcC1::GetStreamContext();
...
TEST_CASE("32fcC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fcC1::GetStreamContext();
...
TEST_CASE("32fcC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fcC1::GetStreamContext();
...
TEST_CASE("64fC1", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("64fC2", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image64fC1::GetStreamContext();
...
TEST_CASE("64fC3", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image64fC1::GetStreamContext();
...
TEST_CASE("64fC4", "[NPP.Statistics.MaximumError]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image64fC1::GetStreamContext();
