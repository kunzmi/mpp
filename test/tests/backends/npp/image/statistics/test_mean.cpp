...
TEST_CASE("8uC1", "[NPP.Statistics.Mean]")
{
    ...
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.MeanGetBufferHostSize(nppCtx));

    cpu_src1.FillRandom(seed);

    cpu_src1 >> npp_src1;

    npp_src1.Mean(npp_buffer, npp_dst, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC3", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC4", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("8uC1", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    nv::Image8uC1 npp_src1(size, size);
    opp::cuda::DevVar<double> npp_dst(1);
    opp::cuda::DevVar<byte> npp_buffer(npp_src1.MeanGetBufferHostSizeMasked(nppCtx));
    ...
    npp_src1.Mean(npp_mask, npp_buffer, npp_dst, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8uC3", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
    ...
    npp_src1.Mean(npp_mask, 1, npp_buffer, npp_dst, nppCtx);
    npp_src1.Mean(npp_mask, 2, npp_buffer, npp_dst2, nppCtx);
    npp_src1.Mean(npp_mask, 3, npp_buffer, npp_dst3, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("8sC1", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8sC3", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8sC1::GetStreamContext();
    ...
    npp_src1.Mean(npp_mask, 1, npp_buffer, npp_dst1, nppCtx);
    npp_src1.Mean(npp_mask, 2, npp_buffer, npp_dst2, nppCtx);
    npp_src1.Mean(npp_mask, 3, npp_buffer, npp_dst3, nppCtx);
    npp_dst >> npp_res;
...
TEST_CASE("16uC1", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC3", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("16sC4", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16sC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Statistics.Mean]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC3", "[NPP.Statistics.MeanMasked]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
