...
TEST_CASE("8uC1", "[NPP.Arithmetic.Mul]")
{
    ...
    npp_src1.Mul(npp_src2, npp_dst, 0, nppCtx);
    ...
    npp_src1.Mul(npp_src2, npp_dst, 8, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dst.Mul(cpu_src2, 8);
    npp_dst.Mul(npp_src2, 8, nppCtx);
...
TEST_CASE("8uC3", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4A", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC4::GetStreamContext();
    ...
    cpu_src1A.Mul(cpu_src2A, cpu_dstA);
    npp_src1.MulA(npp_src2, npp_dst, 0, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_src1A.Mul(cpu_src2A, cpu_dstA, 8);
    npp_src1.MulA(npp_src2, npp_dst, 8, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dstA.Mul(cpu_src2A, cpu_dstA, 8);
    npp_dst.MulA(npp_src2, 8, nppCtx);
...
TEST_CASE("16uC1", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4A", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC4::GetStreamContext();
    ...
    cpu_src1A.Mul(cpu_src2A, cpu_dstA, 16);
    ...
    cpu_dstA.Mul(cpu_src2A, cpu_dstA, 16);
...
TEST_CASE("32sC1", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
    ...
    cpu_src1.Mul(cpu_src2, cpu_dst, 2);
    npp_src1.Mul(npp_src2, npp_dst, 2, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dst.Mul(cpu_src2, 1);
    npp_dst.Mul(npp_src2, 1, nppCtx);
...
TEST_CASE("32sC3", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16fC1", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
    ...
    cpu_src1.Mul(cpu_src2, cpu_dst);
    npp_src1.Mul(npp_src2, npp_dst, nppCtx);
...
TEST_CASE("16fC3", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16fC4", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4A", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
    ...
    cpu_src1A.Mul(cpu_src2A, cpu_dstA);
    npp_src1.MulA(npp_src2, npp_dst, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dstA.Mul(cpu_src2A, cpu_dstA);
    npp_dst.MulA(npp_src2, nppCtx);
...
TEST_CASE("16scC1", "[NPP.Arithmetic.Mul]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC1", "[NPP.Arithmetic.MulC]")
{
    ...
    npp_src1.Mul(constVal, npp_dst, 0, nppCtx);
    ...
    npp_src1.Mul(constVal, npp_dst, 8, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dst.Mul(constVal, 8);
    npp_dst.Mul(constVal, 8, nppCtx);
...
TEST_CASE("8uC3", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC3::GetStreamContext();
...
TEST_CASE("8uC4", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC4::GetStreamContext();
...
TEST_CASE("8uC4A", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC4::GetStreamContext();
    ...
    cpu_src1A.Mul(constVal, cpu_dstA);
    npp_src1.MulA(constVal.XYZ(), npp_dst, 0, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_src1A.Mul(constVal, cpu_dstA, 8);
    npp_src1.MulA(constVal.XYZ(), npp_dst, 8, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dstA.Mul(constVal, cpu_dstA, 8);
    npp_dst.MulA(constVal.XYZ(), npp_dst, 8, nppCtx);
...
TEST_CASE("16uC1", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC1::GetStreamContext();
...
TEST_CASE("16uC3", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC3::GetStreamContext();
...
TEST_CASE("16uC4", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC4::GetStreamContext();
...
TEST_CASE("16uC4A", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16uC4::GetStreamContext();
    ...
    cpu_src1A.Mul(constVal, cpu_dstA, 16);
    ...
    cpu_dstA.Mul(constVal, cpu_dstA, 16);
...
TEST_CASE("32sC1", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC1::GetStreamContext();
    ...
    cpu_src1.Mul(constVal, cpu_dst, 2);
    npp_src1.Mul(constVal, npp_dst, 2, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dst.Mul(constVal, 1);
    npp_dst.Mul(constVal, 1, nppCtx);
...
TEST_CASE("32sC3", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32sC3::GetStreamContext();
...
TEST_CASE("16fC1", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16fC1::GetStreamContext();
    ...
    cpu_src1.Mul(constVal, cpu_dst);
    npp_src1.Mul(constVal, npp_dst, nppCtx);
...
TEST_CASE("16fC3", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16fC3::GetStreamContext();
...
TEST_CASE("16fC4", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16fC4::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
...
TEST_CASE("32fC3", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC3::GetStreamContext();
...
TEST_CASE("32fC4", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
...
TEST_CASE("32fC4A", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
    ...
    cpu_src1A.Mul(constVal, cpu_dstA);
    npp_src1.MulA(constVal.XYZ(), npp_dst, nppCtx);

    npp_res << npp_dst;

    CHECK(cpu_dst.IsIdentical(npp_res));

    cpu_dstA.Mul(constVal, cpu_dstA);
    npp_dst.MulA(constVal.XYZ(), npp_dst, nppCtx);
...
TEST_CASE("16scC1", "[NPP.Arithmetic.MulC]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image16scC1::GetStreamContext();
