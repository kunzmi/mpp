...
TEST_CASE("8uC1", "[NPP.Arithmetic.AddSquare]")
{
    ...
    npp_dst.AddSquare(npp_src1, nppCtx);
...
TEST_CASE("8uC1", "[NPP.Arithmetic.AddSquareMasked]")
{
...
TEST_CASE("16uC1", "[NPP.Arithmetic.AddSquare]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("16uC1", "[NPP.Arithmetic.AddSquareMasked]")
{
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    const uint seed                  = Catch::getSeed();
    NppStreamContext nppCtx          = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Arithmetic.AddSquare]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("32fC1", "[NPP.Arithmetic.AddSquareMasked]")
{
    const std::filesystem::path root = std::filesystem::path(TEST_DATA_DIR);
    const uint seed                  = Catch::getSeed();
    NppStreamContext nppCtx          = nv::Image8uC1::GetStreamContext();
