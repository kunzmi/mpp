...
TEST_CASE("8uC1", "[NPP.Filtering.MaxFilter]")
{
    ...
    npp_src1.FilterMaxBorder(npp_dst, {5, 5}, {2, 2}, NPP_BORDER_REPLICATE, nppCtx);
    npp_res << npp_dst;

    cpu_src1.MaxFilter(cpu_dst, 5, BorderType::Replicate);

    CHECK(cpu_dst.IsIdentical(npp_res));
}

TEST_CASE("8uC3", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC1", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC1", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC4", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4A", "[NPP.Filtering.MaxFilter]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
    ...
    cpu_src1A.MaxFilter(cpu_dst, 5, BorderType::Replicate);
