...
TEST_CASE("8uC1", "[NPP.Filtering.GaussAdvancedFilter]")
{
    ...
    npp_src1.FilterGaussAdvancedBorder(npp_dst, 7, filterd, NPP_BORDER_REPLICATE, nppCtx);
    npp_res << npp_dst;

    cpu_src1.SeparableFilter(cpu_dst, filter.data(), 7, 3, BorderType::Replicate);

    CHECK(cpu_dst.IsSimilar(npp_res, 1));
}

TEST_CASE("8uC3", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC1", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC4", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC1", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC4", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4A", "[NPP.Filtering.GaussAdvancedFilter]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
    ...
    cpu_src1A.SeparableFilter(cpu_dst, filter.data(), 7, 3, BorderType::Replicate);
