...
TEST_CASE("8uC1", "[NPP.Filtering.RobertsDownFilter]")
{
    ...
    npp_src1.FilterRobertsDownBorder(npp_dst, NPP_BORDER_REPLICATE, nppCtx);
    npp_res << npp_dst;

    cpu_src1.FixedFilter(cpu_dst, FixedFilter::RobertsDown, MaskSize::Mask_3x3, BorderType::Replicate);

    CHECK(cpu_dst.IsIdentical(npp_res));
}

TEST_CASE("8uC3", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("8uC4", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC1", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC4", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC4A", "[NPP.Filtering.RobertsDownFilter]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC4::GetStreamContext();
    ...
    cpu_src1A.FixedFilter(cpu_dst, FixedFilter::RobertsDown, MaskSize::Mask_3x3, BorderType::Replicate);
