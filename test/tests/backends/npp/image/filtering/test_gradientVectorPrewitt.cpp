...
TEST_CASE("8uC1", "[NPP.Filtering.GradientVectorPrewitt]")
{
    ...
    npp_src1.GradientVectorPrewittBorder(npp_dstX, npp_dstY, npp_dstMag, npp_dstAngle, NPP_MASK_SIZE_3_X_3, nppiNormL1,
    ...
    cpu_src1.GradientVectorPrewitt(cpu_dstX, cpu_dstY, cpu_dstMag, cpu_dstAngle, cpu_dstCoVar, Norm::L1,
    ...
    npp_src1.GradientVectorPrewittBorder(npp_dstX, npp_dstY, npp_dstMag, npp_dstAngle, NPP_MASK_SIZE_3_X_3, nppiNormL2,
                                         NPP_BORDER_REPLICATE, nppCtx);
    npp_resX << npp_dstX;
    npp_resY << npp_dstY;
    npp_resMag << npp_dstMag;
    ...
    cpu_src1.GradientVectorPrewitt(cpu_dstX, cpu_dstY, cpu_dstMag, cpu_dstAngle, cpu_dstCoVar, Norm::L2,
                                   MaskSize::Mask_3x3, BorderType::Replicate);

    CHECK(cpu_dstMag.IsSimilar(npp_resMag, 1)); // it seems NPP doesn't do any rounding
}

TEST_CASE("8uC3", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC1", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC3", "[NPP.Filtering.GradientVectorPrewitt]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
