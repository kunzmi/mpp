...
TEST_CASE("8uC1", "[NPP.Filtering.GradientVectorSobel]")
{
    ...
    npp_src1.GradientVectorSobelBorder(npp_dstX, npp_dstY, npp_dstMag, npp_dstAngle, NPP_MASK_SIZE_3_X_3, nppiNormL1,
    ...
    cpu_src1.GradientVectorSobel(cpu_dstX, cpu_dstY, cpu_dstMag, cpu_dstAngle, cpu_dstCoVar, Norm::L1,
                                 MaskSize::Mask_3x3, BorderType::Replicate);

    CHECK(cpu_dstX.IsIdentical(npp_resX));
    CHECK(cpu_dstY.IsIdentical(npp_resY));
    CHECK(cpu_dstMag.IsIdentical(npp_resMag));
    CHECK(cpu_dstAngle.IsSimilar(npp_resAngle, 0.000001f));

    npp_src1.GradientVectorSobelBorder(npp_dstX, npp_dstY, npp_dstMag, npp_dstAngle, NPP_MASK_SIZE_3_X_3, nppiNormL2,
                                       NPP_BORDER_REPLICATE, nppCtx);
    npp_resX << npp_dstX;
    npp_resY << npp_dstY;
    npp_resMag << npp_dstMag;
    ...
    cpu_src1.GradientVectorSobel(cpu_dstX, cpu_dstY, cpu_dstMag, cpu_dstAngle, cpu_dstCoVar, Norm::L2,
                                 MaskSize::Mask_3x3, BorderType::Replicate);

    CHECK(cpu_dstMag.IsSimilar(npp_resMag, 1)); // it seems NPP doesn't do any rounding

    npp_src1.GradientVectorSobelBorder(npp_dstX, npp_dstY, npp_dstMag, npp_dstAngle, NPP_MASK_SIZE_5_X_5, nppiNormL1,
                                       NPP_BORDER_REPLICATE, nppCtx);
    npp_resX << npp_dstX;
    npp_resY << npp_dstY;
    npp_resMag << npp_dstMag;
    ...
    cpu_src1.GradientVectorSobel(cpu_dstX, cpu_dstY, cpu_dstMag, cpu_dstAngle, cpu_dstCoVar, Norm::L1,
                                 MaskSize::Mask_5x5, BorderType::Replicate);
    ...
    npp_src1.GradientVectorSobelBorder(npp_dstX, npp_dstY, npp_dstMag, npp_dstAngle, NPP_MASK_SIZE_5_X_5, nppiNormL2,
                                       NPP_BORDER_REPLICATE, nppCtx);
    npp_resX << npp_dstX;
    npp_resY << npp_dstY;
    npp_resMag << npp_dstMag;
...
TEST_CASE("8uC3", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image8uC1::GetStreamContext();
...
TEST_CASE("16sC1", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16sC3", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC1", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("16uC3", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
...
TEST_CASE("32fC1", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
    ...
    CHECK(cpu_dstX.IsSimilar(npp_resX, 0.000001f));
    CHECK(cpu_dstY.IsSimilar(npp_resY, 0.000001f));
    CHECK(cpu_dstMag.IsSimilar(npp_resMag, 0.000001f));
    CHECK(cpu_dstAngle.IsSimilar(npp_resAngle, 0.0001f));
...
TEST_CASE("32fC3", "[NPP.Filtering.GradientVectorSobel]")
{
    const uint seed         = Catch::getSeed();
    NppStreamContext nppCtx = nv::Image32fC1::GetStreamContext();
