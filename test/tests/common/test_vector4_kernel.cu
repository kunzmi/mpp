...
template <typename T> __global__ void test_vector4_kernel(Vector4<T> *aDataIn, Vector4<T> *aDataOut, Pixel8uC4 *aComp)
{
    ...
    if (blockIdx.x == 9)
    {
        ...
        aComp[counterComp]     = static_cast<byte>(aDataIn[counterIn] == aDataIn[counterIn + 1]) * TRUE_VALUE;
        aComp[counterComp + 1] = static_cast<byte>(aDataIn[counterIn + 2] != aDataIn[counterIn + 3]) * TRUE_VALUE;
        counterComp += 2;
        counterIn += 4;
        ...
        if constexpr (RealNumber<T>)
        {
            aComp[counterComp]     = static_cast<byte>(aDataIn[counterIn] >= aDataIn[counterIn + 1]) * TRUE_VALUE;
            aComp[counterComp + 1] = static_cast<byte>(aDataIn[counterIn + 2] > aDataIn[counterIn + 3]) * TRUE_VALUE;
            aComp[counterComp + 2] = static_cast<byte>(aDataIn[counterIn + 4] <= aDataIn[counterIn + 5]) * TRUE_VALUE;
            aComp[counterComp + 3] = static_cast<byte>(aDataIn[counterIn + 6] < aDataIn[counterIn + 7]) * TRUE_VALUE;
            counterComp += 4;
            counterIn += 8;
        }
    }
...
{
    test_vector4_kernel<<<10, 1>>>(aDataIn, aDataOut, aComp);
}

template void runtest_vector4_kernel<sbyte>(Pixel8sC4 *aDataIn, Pixel8sC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<byte>(Pixel8uC4 *aDataIn, Pixel8uC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<short>(Pixel16sC4 *aDataIn, Pixel16sC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<ushort>(Pixel16uC4 *aDataIn, Pixel16uC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<int>(Pixel32sC4 *aDataIn, Pixel32sC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<uint>(Pixel32uC4 *aDataIn, Pixel32uC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<BFloat16>(Pixel16bfC4 *aDataIn, Pixel16bfC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<HalfFp16>(Pixel16hfC4 *aDataIn, Pixel16hfC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<float>(Pixel32fC4 *aDataIn, Pixel32fC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<double>(Pixel64fC4 *aDataIn, Pixel64fC4 *aDataOut, Pixel8uC4 *aComp);

template void runtest_vector4_kernel<c_short>(Pixel16scC4 *aDataIn, Pixel16scC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<c_int>(Pixel32scC4 *aDataIn, Pixel32scC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<c_BFloat16>(Pixel16bfcC4 *aDataIn, Pixel16bfcC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<c_HalfFp16>(Pixel16fcC4 *aDataIn, Pixel16fcC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<c_float>(Pixel32fcC4 *aDataIn, Pixel32fcC4 *aDataOut, Pixel8uC4 *aComp);
template void runtest_vector4_kernel<c_double>(Pixel64fcC4 *aDataIn, Pixel64fcC4 *aDataOut, Pixel8uC4 *aComp);
