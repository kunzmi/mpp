...
void runPixel16uC4(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const opp::image::Border &aBorder,
                   std::ofstream &aCsv)
{
    using oppT       = Pixel16uC4;
    ...
    RowWindowSumTest<oppT, resFloatT, nppT, nv::Image32fC4> testRowWindowSum(aIterations, aRepeats, aWidth, aHeight);
    ColumnWindowSumTest<oppT, resFloatT, nppT, nv::Image32fC4> testColumnWindowSum(aIterations, aRepeats, aWidth,
                                                                                   aHeight);
    ...
    MaxTest<oppT, oppT, nppT, opp::ushort, vector_active_size_v<oppT>> testMax(aIterations, aRepeats, aWidth, aHeight);
