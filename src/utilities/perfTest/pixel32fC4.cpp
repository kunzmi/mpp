...
#include <backends/npp/image/image32fC4View.h>   //NOLINT
...
void runPixel32fC4(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const mpp::image::Border &aBorder,
                   std::ofstream &aCsv)
{
    using mppT = Pixel32fC4;
    using nppT = nv::Image32fC4;
    ...
    MaxTest<mppT, mppT, nppT, float, vector_active_size_v<mppT>> testMax(aIterations, aRepeats, aWidth, aHeight);
