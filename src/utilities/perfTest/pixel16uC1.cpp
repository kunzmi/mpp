...
#include <backends/npp/image/image16uC1View.h> //NOLINT
...
void runPixel16uC1(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const mpp::image::Border &aBorder,
                   std::ofstream &aCsv)
{
    using mppT       = Pixel16uC1;
    using nppT       = nv::Image16uC1;
