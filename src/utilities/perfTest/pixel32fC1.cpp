...
void runPixel32fC1(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const opp::image::Border &aBorder,
                   std::ofstream &aCsv)
{
    using oppT       = Pixel32fC1;
    ...
    MaxTest<oppT, oppT, nppT, float, vector_active_size_v<oppT>> testMax(aIterations, aRepeats, aWidth, aHeight);
