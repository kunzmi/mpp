...
void runPixel32fC1(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const mpp::image::Border &aBorder,
                   std::ofstream &aCsv)
{
    using mppT       = Pixel32fC1;
    using nppT       = nv::Image32fC1;
