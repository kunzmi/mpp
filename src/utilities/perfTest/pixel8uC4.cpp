...
void runPixel8uC4(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const mpp::image::Border &aBorder,
                  std::ofstream &aCsv)
{
    using mppT       = Pixel8uC4;
    using nppT       = nv::Image8uC4;
    using resFloatT  = Pixel32fC4;
    using resDoubleT = Pixel64fC4;
    ...
    RowWindowSumTest<mppT, resFloatT, nppT, nv::Image32fC4> testRowWindowSum(aIterations, aRepeats, aWidth, aHeight);
    ColumnWindowSumTest<mppT, resFloatT, nppT, nv::Image32fC4> testColumnWindowSum(aIterations, aRepeats, aWidth,
                                                                                   aHeight);
