...
void runPixel8uC3(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const opp::image::Border &aBorder,
                  std::ofstream &aCsv)
{
    using oppT       = Pixel8uC3;
    ...
    RowWindowSumTest<oppT, resFloatT, nppT, nv::Image32fC3> testRowWindowSum(aIterations, aRepeats, aWidth, aHeight);
    ColumnWindowSumTest<oppT, resFloatT, nppT, nv::Image32fC3> testColumnWindowSum(aIterations, aRepeats, aWidth,
                                                                                   aHeight);
