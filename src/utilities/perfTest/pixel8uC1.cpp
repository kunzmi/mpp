...
void runPixel8uC1(size_t aIterations, size_t aRepeats, int aWidth, int aHeight, const mpp::image::Border &aBorder,
                  std::ofstream &aCsv)
{
    using mppT       = Pixel8uC1;
    ...
    RowWindowSumTest<mppT, resFloatT, nppT, nv::Image32fC1> testRowWindowSum(aIterations, aRepeats, aWidth, aHeight);
    ColumnWindowSumTest<mppT, resFloatT, nppT, nv::Image32fC1> testColumnWindowSum(aIterations, aRepeats, aWidth,
                                                                                   aHeight);
    ...
    MaxTest<mppT, mppT, nppT, byte, vector_active_size_v<mppT>> testMax(aIterations, aRepeats, aWidth, aHeight);
    ...
    MSETest<mppT, resDoubleT, nppT, float, vector_active_size_v<mppT>> testMSE(aIterations, aRepeats, aWidth, aHeight);
    ...
    aCsv << testBoxFilter.GetResult<cpu::Image<mppT>, resDoubleT>();
    ...
    aCsv << testLowPassFilter.GetResult<cpu::Image<mppT>, resDoubleT>();
    ...
    aCsv << testGaussFilter.GetResult<cpu::Image<mppT>, resDoubleT>();
    ...
    aCsv << testGaussAdvancedilter.GetResult<cpu::Image<mppT>, resDoubleT>();
    ...
    testMax.Run(roi);
    aCsv << testMax.GetResult<mppT, mppT>();
