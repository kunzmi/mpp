...
class Image64fC1View : public ImageView<Pixel64fC1>
{
  ...
  public:
    ...
    void Dilate3x3(Image64fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Erode3x3(Image64fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterColumn(Image64fC1View &pDst, const cuda::DevVarView<double> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterRow(Image64fC1View &pDst, const cuda::DevVarView<double> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Filter(Image64fC1View &pDst, const cuda::DevVarView<double> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBox(Image64fC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBoxBorderAdvanced(Image64fC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, cuda::DevVarView<byte> &pBuffer64, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void CrossCorrFull_Norm(const Image64fC1View &pTpl, Image64fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_Norm(const Image64fC1View &pTpl, Image64fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_Norm(const Image64fC1View &pTpl, Image64fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid(const Image64fC1View &pTpl, Image64fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevel(const Image64fC1View &pTpl, Image64fC1View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevel(const Image64fC1View &pTpl, Image64fC1View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevel(const Image64fC1View &pTpl, Image64fC1View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevelAdvanced(const Image64fC1View &pTpl, Image64fC1View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevelAdvanced(const Image64fC1View &pTpl, Image64fC1View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevelAdvanced(const Image64fC1View &pTpl, Image64fC1View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void ResizeSqrPixel(Image64fC1View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Remap(const Image64fC1View &pXMap, const Image64fC1View &pYMap, Image64fC1View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpAffine(Image64fC1View &pDst, const double aCoeffs[2][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
