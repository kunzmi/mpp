...
class MPPEXPORT_NPP Image32scC1View : public ImageView<Pixel32scC1>
{
  protected:
  ...
  public:
    ...
    ~Image32scC1View() override = default;
    ...
    /// </summary>
    [[nodiscard]] Image32scC1View GetView(const Roi &aRoi);

    /// <summary>
    /// Returns a new ImageView with the current ROI adapted by aBorder
    /// </summary>
    [[nodiscard]] Image32scC1View GetView(const Border &aBorder = Border());
    ...
    Image32scC1View &Set(const Pixel32scC1 &oValue, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Copy(Image32scC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Add(const Pixel32scC1 &nConstant, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Add(const Pixel32scC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Mul(const Pixel32scC1 &nConstant, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Mul(const Pixel32scC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Sub(const Pixel32scC1 &nConstant, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Sub(const Pixel32scC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Div(const Pixel32scC1 &nConstant, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Div(const Pixel32scC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Add(const Image32scC1View &pSrc2, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Add(const Image32scC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Mul(const Image32scC1View &pSrc2, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Mul(const Image32scC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Sub(const Image32scC1View &pSrc2, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Sub(const Image32scC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image32scC1View &Div(const Image32scC1View &pSrc2, Image32scC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32scC1View &Div(const Image32scC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void MaximumError(const Image32scC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageError(const Image32scC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumRelativeError(const Image32scC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageRelativeError(const Image32scC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
