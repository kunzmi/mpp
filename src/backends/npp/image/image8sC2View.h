...
class Image8sC2View : public ImageView<Pixel8sC2>
{
  ...
  public:
    ...
    void Set(const Pixel8sC2 &aValue, const NppStreamContext &nppStreamCtx);
    ...
    void Copy(Image8sC2View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void ColorTwist32f(Image8sC2View &pDst, const Npp32f aTwist[3][4], const NppStreamContext &nppStreamCtx) const;
    ...
    void Filter32f(Image8sC2View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBorder32f(Image8sC2View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
