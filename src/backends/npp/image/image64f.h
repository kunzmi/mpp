...
class Image64fC1 : public Image64fC1View
{
  public:
    Image64fC1() = delete;
...
class Image64fC2 : public Image64fC2View
{
  public:
    Image64fC2() = delete;
...
class Image64fC3 : public Image64fC3View
{
  public:
    Image64fC3() = delete;
...
class Image64fC4 : public Image64fC4View
{
  public:
    Image64fC4() = delete;
