...
{
// forward declaration:
class MPPEXPORTFWDDECL_NPP Image16fC4View;
...
class MPPEXPORTFWDDECL_NPP Image8sC4View;
class MPPEXPORTFWDDECL_NPP Image8uC1View;
class MPPEXPORTFWDDECL_NPP Image8uC4View;

class MPPEXPORT_NPP Image32fC4View : public ImageView<Pixel32fC4>
{
  protected:
  ...
  public:
    ...
    ~Image32fC4View() override = default;
    ...
    /// </summary>
    [[nodiscard]] Image32fC4View GetView(const Roi &aRoi);
    ...
    Image8uC1View &Compare(const Pixel32fC4 &pConstants, Image8uC1View &pDst, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
