...
class Image32sC1View : public ImageView<Pixel32sC1>
{
  ...
  public:
    ...
    void Set(const Pixel32sC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    void Set(const Pixel32sC1 &nValue, const Image8uC1View &pMask, const NppStreamContext &nppStreamCtx);
    ...
    void Copy(Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Copy(Image32sC1View &pDst, const Image8uC1View &pMask, const NppStreamContext &nppStreamCtx) const;
    ...
    void Copy(size_t aDstChannel, Image32sC3View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Copy(size_t aDstChannel, Image32sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyConstBorder(Image32sC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const Pixel32sC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyReplicateBorder(Image32sC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyWrapBorder(Image32sC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopySubpix(Image32sC1View &pDst, const Pixel32fC1 &nDx, const Pixel32fC1 &nDy, const NppStreamContext &nppStreamCtx) const;
    ...
    void Convert(Image8sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Dup(Image32sC3View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Dup(Image32sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void DupA(Image32sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Transpose(Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Pixel32sC1 &nConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const cuda::DevVarView<Pixel8uC1> &pConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Pixel32sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Mul(const Pixel32sC1 &nConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const cuda::DevVarView<Pixel8uC1> &pConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const Pixel32sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Sub(const Pixel32sC1 &nConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const cuda::DevVarView<Pixel8uC1> &pConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const Pixel32sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Div(const Pixel32sC1 &nConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const cuda::DevVarView<Pixel8uC1> &pConstant, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const Pixel32sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Add(const Image32sC1View &pSrc2, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Image32sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Mul(const Image32sC1View &pSrc2, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const Image32sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Sub(const Image32sC1View &pSrc2, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const Image32sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Div(const Image32sC1View &pSrc2, Image32sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const Image32sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void And(const Pixel32sC1 &nConstant, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void And(const Pixel32sC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    void Or(const Pixel32sC1 &nConstant, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Or(const Pixel32sC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    void Xor(const Pixel32sC1 &nConstant, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Xor(const Pixel32sC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    void RShift(Npp32u nConstant, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void LShift(Npp32u nConstant, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void And(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void And(const Image32sC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    void Or(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Or(const Image32sC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    void Xor(const Image32sC1View &pSrc2, Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Xor(const Image32sC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    void AlphaComp(const Pixel32sC1 &nAlpha1, const Image32sC1View &pSrc2, const Pixel32sC1 &nAlpha2, Image32sC1View &pDst, NppiAlphaOp eAlphaOp, const NppStreamContext &nppStreamCtx) const;
    ...
    void AlphaComp(const Image32sC1View &pSrc2, Image32sC1View &pDst, NppiAlphaOp eAlphaOp, const NppStreamContext &nppStreamCtx) const;
    ...
    void Filter32f(Image32sC1View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBorder32f(Image32sC1View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void Mirror(Image32sC1View &pDst, NppiAxis flip, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpAffine(Image32sC1View &pDst, const double aCoeffs[2][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpAffineBack(Image32sC1View &pDst, const double aCoeffs[2][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpAffineQuad(const double aSrcQuad[4][2], Image32sC1View &pDst, const double aDstQuad[4][2], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpPerspective(Image32sC1View &pDst, const double aCoeffs[3][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpPerspectiveBack(Image32sC1View &pDst, const double aCoeffs[3][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpPerspectiveQuad(const double aSrcQuad[4][2], Image32sC1View &pDst, const double aDstQuad[4][2], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
