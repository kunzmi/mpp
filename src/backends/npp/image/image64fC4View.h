...
class Image64fC4View : public ImageView<Pixel64fC4>
{
  ...
  public:
    ...
    void CrossCorrFull_Norm(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormA(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_Norm(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormA(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_Norm(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormA(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevel(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevelA(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevel(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevelA(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevel(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevelA(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevelAdvanced(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevelAdvanced(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevelAdvanced(const Image64fC4View &pTpl, Image64fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumError(const Image64fC4View &pSrc2, cuda::DevVarView<double> &pError, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageError(const Image64fC4View &pSrc2, cuda::DevVarView<double> &pError, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumRelativeError(const Image64fC4View &pSrc2, cuda::DevVarView<double> &pError, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageRelativeError(const Image64fC4View &pSrc2, cuda::DevVarView<double> &pError, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void ResizeSqrPixel(Image64fC4View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void ResizeSqrPixelA(Image64fC4View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Remap(const Image64fC1View &pXMap, const Image64fC1View &pYMap, Image64fC4View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void RemapA(const Image64fC1View &pXMap, const Image64fC1View &pYMap, Image64fC4View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpAffine(Image64fC4View &pDst, const double aCoeffs[2][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void WarpAffineA(Image64fC4View &pDst, const double aCoeffs[2][3], int eInterpolation, const NppStreamContext &nppStreamCtx) const;
