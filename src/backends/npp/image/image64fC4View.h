...
class MPPEXPORT_NPP Image64fC4View : public ImageView<Pixel64fC4>
{
  protected:
    Image64fC4View() = default;
    explicit Image64fC4View(const Size2D &aSize);

  public:
    Image64fC4View(Pixel64fC4 *aBasePointer, const SizePitched &aSizeAlloc);
    Image64fC4View(Pixel64fC4 *aBasePointer, const SizePitched &aSizeAlloc, const Roi &aRoi);
    ~Image64fC4View() override = default;

    Image64fC4View(const Image64fC4View &)     = default;
    Image64fC4View(Image64fC4View &&) noexcept = default;

    Image64fC4View &operator=(const Image64fC4View &)     = default;
    Image64fC4View &operator=(Image64fC4View &&) noexcept = default;

    /// <summary>
    /// Returns a new Image64fC4View with the new ROI
    /// </summary>
    [[nodiscard]] Image64fC4View GetView(const Roi &aRoi);

    /// <summary>
    /// Returns a new ImageView with the current ROI adapted by aBorder
    /// </summary>
    [[nodiscard]] Image64fC4View GetView(const Border &aBorder = Border());
    ...
    Image64fC4View &CrossCorrFull_Norm(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrFull_NormA(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrSame_Norm(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrSame_NormA(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrValid_Norm(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrValid_NormA(const Image64fC4View &pTpl, Image64fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrFull_NormLevel(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrFull_NormLevelA(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrSame_NormLevel(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrSame_NormLevelA(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrValid_NormLevel(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrValid_NormLevelA(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrFull_NormLevelAdvanced(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrSame_NormLevelAdvanced(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &CrossCorrValid_NormLevelAdvanced(const Image64fC4View &pTpl, Image64fC4View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumError(const Image64fC4View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageError(const Image64fC4View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumRelativeError(const Image64fC4View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageRelativeError(const Image64fC4View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &ResizeSqrPixel(Image64fC4View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &ResizeSqrPixelA(Image64fC4View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;

    // NppStatus nppiResizeSqrPixel_64f_P4R_Ctx(const Npp64f *const[4] pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, Npp64f *[4] pDst, int nDstStep, NppiRect oDstROI, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, NppStreamContext nppStreamCtx)
    ...
    Image64fC4View &Remap(const Image64fC1View &pXMap, const Image64fC1View &pYMap, Image64fC4View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image64fC4View &RemapA(const Image64fC1View &pXMap, const Image64fC1View &pYMap, Image64fC4View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;

    // NppStatus nppiRemap_64f_P4R_Ctx(const Npp64f *const[4] pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp64f * pXMap, int nXMapStep, const Npp64f * pYMap, int nYMapStep, Npp64f *[4] pDst, int nDstStep, NppiSize oDstSizeROI, int eInterpolation, NppStreamContext nppStreamCtx)
