...
class MPPEXPORTFWDDECL_NPP Image32sC1View;
class MPPEXPORTFWDDECL_NPP Image32uC1View;
class MPPEXPORTFWDDECL_NPP Image64fC1View;
class MPPEXPORTFWDDECL_NPP Image8sC1View;
class MPPEXPORTFWDDECL_NPP Image8uC3View;
class MPPEXPORTFWDDECL_NPP Image8uC4View;

class MPPEXPORT_NPP Image8uC1View : public ImageView<Pixel8uC1>
{
  protected:
  ...
  public:
    ...
    ~Image8uC1View() override = default;
    ...
    Image8uC1View &Set(const Pixel8uC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Set(const Pixel8uC1 &nValue, const Image8uC1View &pMask, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Copy(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Copy(Image8uC1View &pDst, const Image8uC1View &pMask, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC3View &Copy(size_t aDstChannel, Image8uC3View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC4View &Copy(size_t aDstChannel, Image8uC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CopyConstBorder(Image8uC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const Pixel8uC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CopyReplicateBorder(Image8uC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CopyWrapBorder(Image8uC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CopySubpix(Image8uC1View &pDst, const Pixel32fC1 &nDx, const Pixel32fC1 &nDy, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &Convert(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16uC1View &Scale(Image16uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &Scale(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32sC1View &Scale(Image32sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &Scale(Image32fC1View &pDst, const Pixel32fC1 &nMin, const Pixel32fC1 &nMax, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC3View &Dup(Image8uC3View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC4View &Dup(Image8uC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC4View &DupA(Image8uC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Transpose(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Add(const Pixel8uC1 &nConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Add(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Add(const Pixel8uC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Add(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Mul(const Pixel8uC1 &nConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Mul(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Mul(const Pixel8uC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Mul(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &MulScale(const Pixel8uC1 &nConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &MulScale(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &MulScale(const Pixel8uC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &MulScale(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Sub(const Pixel8uC1 &nConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Sub(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Sub(const Pixel8uC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Sub(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Div(const Pixel8uC1 &nConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Div(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Div(const Pixel8uC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Div(const mpp::cuda::DevVarView<Pixel8uC1> &pConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &AbsDiff(Image8uC1View &pDst, const Pixel8uC1 &nConstant, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &AbsDiff(Image8uC1View &pDst, mpp::cuda::DevVarView<Pixel8uC1> &pConstant, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Add(const Image8uC1View &pSrc2, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Add(const Image8uC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Mul(const Image8uC1View &pSrc2, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Mul(const Image8uC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &MulScale(const Image8uC1View &pSrc2, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &MulScale(const Image8uC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Sub(const Image8uC1View &pSrc2, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Sub(const Image8uC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Div(const Image8uC1View &pSrc2, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Div(const Image8uC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Div_Round(const Image8uC1View &pSrc2, Image8uC1View &pDst, NppRoundMode rndMode, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Div_Round(const Image8uC1View &pSrc, NppRoundMode rndMode, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &AbsDiff(const Image8uC1View &pSrc2, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Sqr(Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Sqr(int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Sqrt(Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Sqrt(int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Ln(Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Ln(int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Exp(Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Exp(int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &And(const Pixel8uC1 &nConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &And(const Pixel8uC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Or(const Pixel8uC1 &nConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Or(const Pixel8uC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Xor(const Pixel8uC1 &nConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Xor(const Pixel8uC1 &nConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &RShift(Npp32u nConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &RShift(Npp32u nConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &LShift(Npp32u nConstant, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &LShift(Npp32u nConstant, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &And(const Image8uC1View &pSrc2, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &And(const Image8uC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Or(const Image8uC1View &pSrc2, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Or(const Image8uC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Xor(const Image8uC1View &pSrc2, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Xor(const Image8uC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Not(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;

    // NppStatus nppiNot_8u_C1IR_Ctx(Npp8u * pSrcDst, int nSrcDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx)
    Image8uC1View &Not(const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &AlphaComp(const Pixel8uC1 &nAlpha1, const Image8uC1View &pSrc2, const Pixel8uC1 &nAlpha2, Image8uC1View &pDst, NppiAlphaOp eAlphaOp, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &AlphaPremul(const Pixel8uC1 &nAlpha1, Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &AlphaPremul(const Pixel8uC1 &nAlpha1, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &AlphaComp(const Image8uC1View &pSrc2, Image8uC1View &pDst, NppiAlphaOp eAlphaOp, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC3View &CFAToRGB(Image8uC3View &pDst, NppiBayerGridPosition eGrid, NppiInterpolationMode eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC4View &CFAToRGBA(Image8uC4View &pDst, NppiBayerGridPosition eGrid, NppiInterpolationMode eInterpolation, const Pixel8uC1 &nAlpha, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CompColorKey(const Image8uC1View &pSrc2, Image8uC1View &pDst, const Pixel8uC1 &nColorKeyConst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &ColorTwist32f(Image8uC1View &pDst, const Npp32f aTwist[3][4], const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &ColorTwist32f(const Npp32f aTwist[3][4], const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &LUT(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pValues, const mpp::cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &LUT(const mpp::cuda::DevVarView<int> &pValues, const mpp::cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &LUT_Linear(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pValues, const mpp::cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &LUT_Linear(const mpp::cuda::DevVarView<int> &pValues, const mpp::cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &LUT_Cubic(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pValues, const mpp::cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &LUT_Cubic(const mpp::cuda::DevVarView<int> &pValues, const mpp::cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &LUTPalette(Image8uC1View &pDst, const mpp::cuda::DevVarView<Pixel8uC1> &pTable, int nBitSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC3View &LUTPalette(Image8uC3View &pDst, const mpp::cuda::DevVarView<Pixel8uC3> &pTable, int nBitSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC4View &LUTPalette(Image8uC4View &pDst, const mpp::cuda::DevVarView<Pixel8uC4> &pTable, int nBitSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold(Image8uC1View &pDst, const Pixel8uC1 &nThreshold, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold(const Pixel8uC1 &nThreshold, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Threshold_GT(Image8uC1View &pDst, const Pixel8uC1 &nThreshold, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold_GT(const Pixel8uC1 &nThreshold, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Threshold_LT(Image8uC1View &pDst, const Pixel8uC1 &nThreshold, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold_LT(const Pixel8uC1 &nThreshold, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Threshold_Val(Image8uC1View &pDst, const Pixel8uC1 &nThreshold, const Pixel8uC1 &nValue, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold_Val(const Pixel8uC1 &nThreshold, const Pixel8uC1 &nValue, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Threshold_GTVal(Image8uC1View &pDst, const Pixel8uC1 &nThreshold, const Pixel8uC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold_GTVal(const Pixel8uC1 &nThreshold, const Pixel8uC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Threshold_LTVal(Image8uC1View &pDst, const Pixel8uC1 &nThreshold, const Pixel8uC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold_LTVal(const Pixel8uC1 &nThreshold, const Pixel8uC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Threshold_LTValGTVal(Image8uC1View &pDst, const Pixel8uC1 &nThresholdLT, const Pixel8uC1 &nValueLT, const Pixel8uC1 &nThresholdGT, const Pixel8uC1 &nValueGT, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Threshold_LTValGTVal(const Pixel8uC1 &nThresholdLT, const Pixel8uC1 &nValueLT, const Pixel8uC1 &nThresholdGT, const Pixel8uC1 &nValueGT, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &Compare(const Image8uC1View &pSrc2, Image8uC1View &pDst, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Compare(const Pixel8uC1 &nConstant, Image8uC1View &pDst, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Dilate(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &DilateBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &GrayDilateBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &Dilate3x3(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Dilate3x3Border(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &Erode(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &ErodeBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &GrayErodeBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &Erode3x3(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Erode3x3Border(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &MorphCloseBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &MorphOpenBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &MorphTopHatBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &MorphBlackHatBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &MorphGradientBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterColumn(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterColumnBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterColumn32f(Image8uC1View &pDst, const mpp::cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterColumnBorder32f(Image8uC1View &pDst, const mpp::cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterRow(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterRowBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterRow32f(Image8uC1View &pDst, const mpp::cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterRowBorder32f(Image8uC1View &pDst, const mpp::cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &Filter(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const Pixel32sC1 &nDivisor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Filter32f(Image8uC1View &pDst, const mpp::cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterBorder(Image8uC1View &pDst, const mpp::cuda::DevVarView<int> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const Pixel32sC1 &nDivisor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterBorder32f(Image8uC1View &pDst, const mpp::cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterBox(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterBoxBorder(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterBoxBorderAdvanced(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterThresholdAdaptiveBoxBorder(Image8uC1View &pDst, NppiSize oMaskSize, const Pixel32fC1 &nDelta, const Pixel8uC1 &nValGT, const Pixel8uC1 &nValLE, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterMax(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterMaxBorder(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterMin(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterMinBorder(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterMedian(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterMedianBorder(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, mpp::cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterPrewittHoriz(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterPrewittVert(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterPrewittHorizBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterPrewittVertBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterScharrHoriz(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterScharrVert(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterScharrHorizBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterScharrVertBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterSobelHoriz(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterSobelHoriz(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterSobelVert(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterSobelVert(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterSobelHorizSecond(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterSobelVertSecond(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image16sC1View &FilterSobelCross(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterSobelHorizBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterSobelHorizBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterSobelVertBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterSobelVertBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterSobelHorizSecondBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterSobelVertSecondBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image16sC1View &FilterSobelCrossBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterRobertsDown(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterRobertsUp(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterRobertsDownBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterRobertsUpBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterLaplace(Image8uC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterLaplaceBorder(Image8uC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterGauss(Image8uC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterGaussAdvanced(Image8uC1View &pDst, const int nFilterTaps, const mpp::cuda::DevVarView<float> &pKernel, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterGaussBorder(Image8uC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterGaussAdvancedBorder(Image8uC1View &pDst, const int nFilterTaps, const mpp::cuda::DevVarView<float> &pKernel, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterGaussPyramidLayerDownBorder(Image8uC1View &pDst, const Pixel32fC1 &nRate, const int nFilterTaps, const mpp::cuda::DevVarView<float> &pKernel, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterGaussPyramidLayerUpBorder(Image8uC1View &pDst, const Pixel32fC1 &nRate, const int nFilterTaps, const mpp::cuda::DevVarView<float> &pKernel, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterBilateralGaussBorder(Image8uC1View &pDst, const int nRadius, const int nStepBetweenSrcPixels, const Pixel32fC1 &nValSquareSigma, const Pixel32fC1 &nPosSquareSigma, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterHighPass(Image8uC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterHighPassBorder(Image8uC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterLowPass(Image8uC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterLowPassBorder(Image8uC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterSharpen(Image8uC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterSharpenBorder(Image8uC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image8uC1View &FilterUnsharpBorder(Image8uC1View &pDst, const Pixel32fC1 &nRadius, const Pixel32fC1 &nSigma, const Pixel32fC1 &nWeight, const Pixel32fC1 &nThreshold, NppiBorderType eBorderType, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FilterWienerBorder(Image8uC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, Npp32f aNoise[1], NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    Image32fC1View &FilterHarrisCornersBorder(Image32fC1View &pDst, NppiDifferentialKernel eFilterType, NppiMaskSize eMaskSize, NppiMaskSize eAvgWindowSize, const Pixel32fC1 &nK, const Pixel32fC1 &nScale, NppiBorderType eBorderType, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterHoughLine(NppPointPolar nDelta, int nThreshold, NppPointPolar *pDeviceLines, int nMaxLineCount, int *pDeviceLineCount, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterHoughLineRegion(NppPointPolar nDelta, int nThreshold, NppPointPolar *pDeviceLines, NppPointPolar oDstROI[2], int nMaxLineCount, int *pDeviceLineCount, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &FloodFill(NppiPoint oSeed, const Pixel8uC1 &nNewValue, NppiNorm eNorm, NppiConnectedRegion *pConnectedRegion, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &FloodFillBoundary(NppiPoint oSeed, const Pixel8uC1 &nNewValue, const Pixel8uC1 &nBoundaryValue, NppiNorm eNorm, NppiConnectedRegion *pConnectedRegion, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &FloodFillRange(NppiPoint oSeed, const Pixel8uC1 &nMin, const Pixel8uC1 &nMax, const Pixel8uC1 &nNewValue, NppiNorm eNorm, NppiConnectedRegion *pConnectedRegion, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &FloodFillRangeBoundary(NppiPoint oSeed, const Pixel8uC1 &nMin, const Pixel8uC1 &nMax, const Pixel8uC1 &nNewValue, const Pixel8uC1 &nBoundaryValue, NppiNorm eNorm, NppiConnectedRegion *pConnectedRegion, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &FloodFillGradient(NppiPoint oSeed, const Pixel8uC1 &nMin, const Pixel8uC1 &nMax, const Pixel8uC1 &nNewValue, NppiNorm eNorm, NppiConnectedRegion *pConnectedRegion, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &FloodFillGradientBoundary(NppiPoint oSeed, const Pixel8uC1 &nMin, const Pixel8uC1 &nMax, const Pixel8uC1 &nNewValue, const Pixel8uC1 &nBoundaryValue, NppiNorm eNorm, NppiConnectedRegion *pConnectedRegion, mpp::cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx);
    ...
    void SegmentWatershed(Image32uC1View &pMarkerLabels, NppiNorm eNorm, NppiWatershedSegmentBoundaryType eSegmentBoundaryType, mpp::cuda::DevVarView<byte> &pDeviceMemoryBuffer, const NppStreamContext &nppStreamCtx);
    ...
    void Sum(mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<long64> &pSum, const NppStreamContext &nppStreamCtx) const;
    ...
    void Min(mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pMin, const NppStreamContext &nppStreamCtx) const;
    ...
    void MinIndx(mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pMin, mpp::cuda::DevVarView<int> &pIndexX, mpp::cuda::DevVarView<int> &pIndexY, const NppStreamContext &nppStreamCtx) const;
    ...
    void Max(mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pMax, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaxIndx(mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pMax, mpp::cuda::DevVarView<int> &pIndexX, mpp::cuda::DevVarView<int> &pIndexY, const NppStreamContext &nppStreamCtx) const;
    ...
    void MinMax(mpp::cuda::DevVarView<byte> &pMin, mpp::cuda::DevVarView<byte> &pMax, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MinMaxIndx(mpp::cuda::DevVarView<byte> &pMinValue, mpp::cuda::DevVarView<byte> &pMaxValue, mpp::cuda::DevVarView<NppiPoint> &pMinIndex, mpp::cuda::DevVarView<NppiPoint> &pMaxIndex, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MinMaxIndx(const Image8uC1View &pMask, mpp::cuda::DevVarView<byte> &pMinValue, mpp::cuda::DevVarView<byte> &pMaxValue, mpp::cuda::DevVarView<NppiPoint> &pMinIndex, mpp::cuda::DevVarView<NppiPoint> &pMaxIndex, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormDiff_Inf(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pNormDiff, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormDiff_Inf(const Image8uC1View &pSrc2, const Image8uC1View &pMask, mpp::cuda::DevVarView<double> &pNormDiff, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormDiff_L1(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pNormDiff, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormDiff_L1(const Image8uC1View &pSrc2, const Image8uC1View &pMask, mpp::cuda::DevVarView<double> &pNormDiff, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormDiff_L2(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pNormDiff, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormDiff_L2(const Image8uC1View &pSrc2, const Image8uC1View &pMask, mpp::cuda::DevVarView<double> &pNormDiff, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormRel_Inf(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pNormRel, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormRel_Inf(const Image8uC1View &pSrc2, const Image8uC1View &pMask, mpp::cuda::DevVarView<double> &pNormRel, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormRel_L1(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pNormRel, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormRel_L1(const Image8uC1View &pSrc2, const Image8uC1View &pMask, mpp::cuda::DevVarView<double> &pNormRel, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormRel_L2(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pNormRel, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void NormRel_L2(const Image8uC1View &pSrc2, const Image8uC1View &pMask, mpp::cuda::DevVarView<double> &pNormRel, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void DotProd(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pDp, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CountInRange(mpp::cuda::DevVarView<int> &pCounts, const Pixel8uC1 &nLowerBound, const Pixel8uC1 &nUpperBound, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &MaxEvery(const Image8uC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &MinEvery(const Image8uC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    Image32sC1View &Integral(Image32sC1View &pDst, const Pixel32sC1 &nVal, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &SqrDistanceFull_Norm(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &SqrDistanceFull_Norm(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &SqrDistanceSame_Norm(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &SqrDistanceSame_Norm(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &SqrDistanceValid_Norm(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &SqrDistanceValid_Norm(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CrossCorrFull_Norm(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrFull_Norm(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CrossCorrSame_Norm(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrSame_Norm(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CrossCorrValid_Norm(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrValid_Norm(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrValid(const Image8uC1View &pTpl, Image32fC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CrossCorrFull_NormLevel(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrFull_NormLevel(const Image8uC1View &pTpl, Image32fC1View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CrossCorrSame_NormLevel(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrSame_NormLevel(const Image8uC1View &pTpl, Image32fC1View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &CrossCorrValid_NormLevel(const Image8uC1View &pTpl, Image8uC1View &pDst, int nScaleFactor, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrValid_NormLevel(const Image8uC1View &pTpl, Image32fC1View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrFull_NormLevelAdvanced(const Image8uC1View &pTpl, Image32fC1View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrSame_NormLevelAdvanced(const Image8uC1View &pTpl, Image32fC1View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image32fC1View &CrossCorrValid_NormLevelAdvanced(const Image8uC1View &pTpl, Image32fC1View &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, mpp::cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void QualityIndex(const Image8uC1View &pSrc2, NppiSize oRoiSize, mpp::cuda::DevVarView<float> &pDst, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumError(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageError(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MaximumRelativeError(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void AverageRelativeError(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<double> &pError, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MSE(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<float> &pMSE, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void PSNR(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<float> &pPSNR, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void SSIM(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<float> &pSSIM, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void MSSSIM(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<float> &pMSSSIM, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void WMSSSIM(const Image8uC1View &pSrc2, mpp::cuda::DevVarView<float> &pMSSSIM, mpp::cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &ResizeSqrPixel(Image8uC1View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &ResizeSqrPixel(Image8uC1View &pDst, double nXFactor, double nYFactor, mpp::cuda::DevVarView<byte> &pBuffer, int eInterpolationMode, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Resize(Image8uC1View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Remap(const Image32fC1View &pXMap, const Image32fC1View &pYMap, Image8uC1View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Rotate(Image8uC1View &pDst, double nAngle, double nShiftX, double nShiftY, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &Mirror(Image8uC1View &pDst, NppiAxis flip, const NppStreamContext &nppStreamCtx) const;

    // NppStatus nppiMirror_8u_C1IR_Ctx(Npp8u * pSrcDst, int nSrcDstStep, NppiSize oROI, NppiAxis flip, NppStreamContext nppStreamCtx)
    Image8uC1View &Mirror(NppiAxis flip, const NppStreamContext &nppStreamCtx);
    ...
    Image8uC1View &WarpAffine(Image8uC1View &pDst, const AffineTransformation<double> &aCoeffs, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &WarpAffineBack(Image8uC1View &pDst, const AffineTransformation<double> &aCoeffs, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &WarpAffineQuad(const Quad<double> &aSrcQuad, Image8uC1View &pDst, const Quad<double> &aDstQuad, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &WarpPerspective(Image8uC1View &pDst, const PerspectiveTransformation<double> &aCoeffs, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &WarpPerspectiveBack(Image8uC1View &pDst, const PerspectiveTransformation<double> &aCoeffs, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    Image8uC1View &WarpPerspectiveQuad(const Quad<double> &aSrcQuad, Image8uC1View &pDst, const Quad<double> &aDstQuad, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
