...
class Image16sC1View : public ImageView<Pixel16sC1>
{
  ...
  public:
    ...
    /// </summary>
    [[nodiscard]] Image16sC1View GetView(const Roi &aRoi) const;

    /// <summary>
    /// Returns a new ImageView with the current ROI adapted by aBorder
    /// </summary>
    [[nodiscard]] Image16sC1View GetView(const Border &aBorder = Border()) const;
    ...
    void Set(const Pixel16sC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    void Set(const Pixel16sC1 &nValue, const Image8uC1View &pMask, const NppStreamContext &nppStreamCtx);
    ...
    void Copy(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Copy(Image16sC1View &pDst, const Image8uC1View &pMask, const NppStreamContext &nppStreamCtx) const;
    ...
    void Copy(size_t aDstChannel, Image16sC3View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Copy(size_t aDstChannel, Image16sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyConstBorder(Image16sC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const Pixel16sC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyReplicateBorder(Image16sC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyWrapBorder(Image16sC1View &pDst, int nTopBorderHeight, int nLeftBorderWidth, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopySubpix(Image16sC1View &pDst, const Pixel32fC1 &nDx, const Pixel32fC1 &nDy, const NppStreamContext &nppStreamCtx) const;
    ...
    void Dup(Image16sC3View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Dup(Image16sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void DupA(Image16sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Transpose(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Pixel16sC1 &nConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const cuda::DevVarView<Pixel8uC1> &pConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Pixel16sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Mul(const Pixel16sC1 &nConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const cuda::DevVarView<Pixel8uC1> &pConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const Pixel16sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Sub(const Pixel16sC1 &nConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const cuda::DevVarView<Pixel8uC1> &pConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const Pixel16sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Div(const Pixel16sC1 &nConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const cuda::DevVarView<Pixel8uC1> &pConstant, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const Pixel16sC1 &nConstant, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Add(const Image16sC1View &pSrc2, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Add(const Image16sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Mul(const Image16sC1View &pSrc2, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mul(const Image16sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Sub(const Image16sC1View &pSrc2, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sub(const Image16sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Div(const Image16sC1View &pSrc2, Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div(const Image16sC1View &pSrc, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Div_Round(const Image16sC1View &pSrc2, Image16sC1View &pDst, NppRoundMode rndMode, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Div_Round(const Image16sC1View &pSrc, NppRoundMode rndMode, int nScaleFactor, const NppStreamContext &nppStreamCtx);
    ...
    void Abs(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sqr(Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Sqrt(Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Ln(Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Exp(Image16sC1View &pDst, int nScaleFactor, const NppStreamContext &nppStreamCtx) const;
    ...
    void RShift(Npp32u nConstant, Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void AlphaComp(const Pixel16sC1 &nAlpha1, const Image16sC1View &pSrc2, const Pixel16sC1 &nAlpha2, Image16sC1View &pDst, NppiAlphaOp eAlphaOp, const NppStreamContext &nppStreamCtx) const;
    ...
    void AlphaComp(const Image16sC1View &pSrc2, Image16sC1View &pDst, NppiAlphaOp eAlphaOp, const NppStreamContext &nppStreamCtx) const;
    ...
    void ColorTwist32f(Image16sC1View &pDst, const Npp32f aTwist[3][4], const NppStreamContext &nppStreamCtx) const;
    ...
    void LUT(Image16sC1View &pDst, const cuda::DevVarView<int> &pValues, const cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx) const;
    ...
    void LUT_Linear(Image16sC1View &pDst, const cuda::DevVarView<int> &pValues, const cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx) const;
    ...
    void LUT_Cubic(Image16sC1View &pDst, const cuda::DevVarView<int> &pValues, const cuda::DevVarView<int> &pLevels, int nLevels, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold(Image16sC1View &pDst, const Pixel16sC1 &nThreshold, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold(const Pixel16sC1 &nThreshold, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx);
    ...
    void Threshold_GT(Image16sC1View &pDst, const Pixel16sC1 &nThreshold, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold_GT(const Pixel16sC1 &nThreshold, const NppStreamContext &nppStreamCtx);
    ...
    void Threshold_LT(Image16sC1View &pDst, const Pixel16sC1 &nThreshold, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold_LT(const Pixel16sC1 &nThreshold, const NppStreamContext &nppStreamCtx);
    ...
    void Threshold_Val(Image16sC1View &pDst, const Pixel16sC1 &nThreshold, const Pixel16sC1 &nValue, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold_Val(const Pixel16sC1 &nThreshold, const Pixel16sC1 &nValue, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx);
    ...
    void Threshold_GTVal(Image16sC1View &pDst, const Pixel16sC1 &nThreshold, const Pixel16sC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold_GTVal(const Pixel16sC1 &nThreshold, const Pixel16sC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    void Threshold_LTVal(Image16sC1View &pDst, const Pixel16sC1 &nThreshold, const Pixel16sC1 &nValue, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold_LTVal(const Pixel16sC1 &nThreshold, const Pixel16sC1 &nValue, const NppStreamContext &nppStreamCtx);
    ...
    void Threshold_LTValGTVal(Image16sC1View &pDst, const Pixel16sC1 &nThresholdLT, const Pixel16sC1 &nValueLT, const Pixel16sC1 &nThresholdGT, const Pixel16sC1 &nValueGT, const NppStreamContext &nppStreamCtx) const;
    ...
    void Threshold_LTValGTVal(const Pixel16sC1 &nThresholdLT, const Pixel16sC1 &nValueLT, const Pixel16sC1 &nThresholdGT, const Pixel16sC1 &nValueGT, const NppStreamContext &nppStreamCtx);
    ...
    void Compare(const Image16sC1View &pSrc2, Image8uC1View &pDst, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Compare(const Pixel16sC1 &nConstant, Image8uC1View &pDst, NppCmpOp eComparisonOperation, const NppStreamContext &nppStreamCtx) const;
    ...
    void MorphCloseBorder(Image16sC1View &pDst, const cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void MorphOpenBorder(Image16sC1View &pDst, const cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void MorphTopHatBorder(Image16sC1View &pDst, const cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void MorphBlackHatBorder(Image16sC1View &pDst, const cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void MorphGradientBorder(Image16sC1View &pDst, const cuda::DevVarView<byte> &pMask, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterColumn(Image16sC1View &pDst, const cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterColumnBorder(Image16sC1View &pDst, const cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterColumn32f(Image16sC1View &pDst, const cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterColumnBorder32f(Image16sC1View &pDst, const cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterRow(Image16sC1View &pDst, const cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterRowBorder(Image16sC1View &pDst, const cuda::DevVarView<int> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const Pixel32sC1 &nDivisor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterRow32f(Image16sC1View &pDst, const cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterRowBorder32f(Image16sC1View &pDst, const cuda::DevVarView<float> &pKernel, Npp32s nMaskSize, Npp32s nAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void Filter(Image16sC1View &pDst, const cuda::DevVarView<int> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const Pixel32sC1 &nDivisor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBorder(Image16sC1View &pDst, const cuda::DevVarView<int> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const Pixel32sC1 &nDivisor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterBox(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBoxBorder(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterBoxBorderAdvanced(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterMax(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterMaxBorder(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterMin(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterMinBorder(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterMedian(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterMedianBorder(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, cuda::DevVarView<byte> &pBuffer, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterPrewittHoriz(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterPrewittVert(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterPrewittHorizBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterPrewittVertBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterSobelHoriz(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterSobelVert(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterSobelHorizBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterSobelVertBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterRobertsDown(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterRobertsUp(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterRobertsDownBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterRobertsUpBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterGauss(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterGaussAdvanced(Image16sC1View &pDst, const int nFilterTaps, const cuda::DevVarView<float> &pKernel, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterGaussBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterGaussAdvancedBorder(Image16sC1View &pDst, const int nFilterTaps, const cuda::DevVarView<float> &pKernel, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterHighPass(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterHighPassBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterLowPass(Image16sC1View &pDst, NppiMaskSize eMaskSize, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterLowPassBorder(Image16sC1View &pDst, NppiMaskSize eMaskSize, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterSharpen(Image16sC1View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterSharpenBorder(Image16sC1View &pDst, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterUnsharpBorder(Image16sC1View &pDst, const Pixel32fC1 &nRadius, const Pixel32fC1 &nSigma, const Pixel32fC1 &nWeight, const Pixel32fC1 &nThreshold, NppiBorderType eBorderType, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterWienerBorder(Image16sC1View &pDst, NppiSize oMaskSize, NppiPoint oAnchor, Npp32f aNoise[1], NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void MaxEvery(const Image16sC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    void MinEvery(const Image16sC1View &pSrc, const NppStreamContext &nppStreamCtx);
    ...
    void ResizeSqrPixel(Image16sC1View &pDst, double nXFactor, double nYFactor, double nXShift, double nYShift, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Resize(Image16sC1View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Remap(const Image32fC1View &pXMap, const Image32fC1View &pYMap, Image16sC1View &pDst, int eInterpolation, const NppStreamContext &nppStreamCtx) const;
    ...
    void Mirror(Image16sC1View &pDst, NppiAxis flip, const NppStreamContext &nppStreamCtx) const;
