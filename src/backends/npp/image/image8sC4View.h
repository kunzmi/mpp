...
class Image8sC4View : public ImageView<Pixel8sC4>
{
  ...
  public:
    ...
    void Set(const Pixel8sC4 &aValue, const NppStreamContext &nppStreamCtx);
    ...
    void SetA(const Pixel8sC3 &aValue, const NppStreamContext &nppStreamCtx);
    ...
    void Copy(Image8sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CopyA(Image8sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void RShiftA(const Pixel32uC3 &aConstants, Image8sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void RShift(const Pixel32uC4 &aConstants, Image8sC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void ColorTwist32f(Image8sC4View &pDst, const Npp32f aTwist[3][4], const NppStreamContext &nppStreamCtx) const;
    ...
    void ColorTwist32fA(Image8sC4View &pDst, const Npp32f aTwist[3][4], const NppStreamContext &nppStreamCtx) const;
    ...
    void Filter32f(Image8sC4View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void Filter32fA(Image8sC4View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, const NppStreamContext &nppStreamCtx) const;
    ...
    void FilterBorder32f(Image8sC4View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void FilterBorder32fA(Image8sC4View &pDst, const cuda::DevVarView<float> &pKernel, NppiSize oKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, const NppStreamContext &nppStreamCtx, const Roi &aFilterArea = Roi()) const;
    ...
    void SqrDistanceFull_Norm(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void SqrDistanceFull_NormA(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void SqrDistanceSame_Norm(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void SqrDistanceSame_NormA(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void SqrDistanceValid_Norm(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void SqrDistanceValid_NormA(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_Norm(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormA(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_Norm(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormA(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_Norm(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormA(const Image8sC4View &pTpl, Image32fC4View &pDst, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevel(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevelA(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevel(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevelA(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevel(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevelA(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrFull_NormLevelAdvanced(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrSame_NormLevelAdvanced(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
    ...
    void CrossCorrValid_NormLevelAdvanced(const Image8sC4View &pTpl, Image32fC4View &pDst, cuda::DevVarView<byte> &pDeviceBuffer, cuda::DevVarView<byte> &pAdvancedScratchBuffer, const NppStreamContext &nppStreamCtx) const;
