...
#define InstantiateDup_For(type)                                                                                       \
    template MPPEXPORT_CUDAI ImageView<Pixel##type##C3> &ImageView<Pixel##type##C1>::Dup<Pixel##type##C3>(             \
        ImageView<Pixel##type##C3> & aDst, const mpp::cuda::StreamCtx &aStreamCtx) const;                              \
    template MPPEXPORT_CUDAI ImageView<Pixel##type##C4> &ImageView<Pixel##type##C1>::Dup<Pixel##type##C4>(             \
        ImageView<Pixel##type##C4> & aDst, const mpp::cuda::StreamCtx &aStreamCtx) const;                              \
    template MPPEXPORT_CUDAI ImageView<Pixel##type##C4A> &ImageView<Pixel##type##C1>::Dup<Pixel##type##C4A>(           \
