...
__global__ void crossCorrelationNormalizedKernelSharedMem(BorderControlT aSrcWithBC, DstT *__restrict__ aDst,
...
template <int WarpAlignmentInBytes, int TupelSize, class ComputeT, class DstT, typename SrcT, int blockWidth,
          int blockHeight, RoundingMode roundingMode, typename BorderControlT>
__global__ void crossCorrelationNormalizedKernel(BorderControlT aSrcWithBC, DstT *__restrict__ aDst, size_t aPitchDst,
...
#pragma unroll
                        for (int bx = 0; bx < TupelSize; bx++)
                        {
                            ...
                            if (tplY >= 0 && tplY < aTemplateSize.y && tplX >= 0 && tplX < aTemplateSize.x)
                            {
                                ...
                                result[by][bx] += srcPixel * ComputeT(tpl);
                                imgSqr[by][bx] += srcPixel * srcPixel;
                            }
                        }
                    }
...
template <typename ComputeT, typename DstT, size_t TupelSize, int WarpAlignmentInBytes, typename SrcT, int blockWidth,
          int blockHeight, RoundingMode roundingMode, typename BorderControlT>
void InvokeCrossCorrelationNormalizedKernel(const dim3 &aBlockSize, uint aSharedMemory, int aWarpSize,
                                            ...
                                            const Size2D &aTemplateSize, const Size2D &aSize)
{
    ...
    if (aSharedMemory == 0)
    {
        crossCorrelationNormalizedKernel<WarpAlignmentInBytes, TupelSize, ComputeT, DstT, SrcT, blockWidth, blockHeight,
    ...
    {
        crossCorrelationNormalizedKernelSharedMem<WarpAlignmentInBytes, TupelSize, ComputeT, DstT, SrcT, blockWidth,
...
void InvokeCrossCorrelationNormalizedKernelDefault(const BorderControlT &aSrcWithBC, DstT *aDst, size_t aPitchDst,
                                                   ...
                                                   const mpp::cuda::StreamCtx &aStreamCtx)
{
    if (aStreamCtx.ComputeCapabilityMajor < INT_MAX)
    {
        ...
        InvokeCrossCorrelationNormalizedKernel<ComputeT, DstT, TupelSize, WarpAlignmentInBytes, SrcT, blockWidth,
                                               blockHeight, roundingMode, BorderControlT>(
