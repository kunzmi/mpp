...
__global__ void forEachPixel420Planar2Kernel(Vector1<remove_vector_t<DstT>> *__restrict__ aDst1, size_t aPitchDst1,
                                             ...
                                             Size2D aSize, funcType aFunctor)
{
    ...
    DstPlaneLumaT *pixelOutLuma1    = gotoPtr(aDst1, aPitchDst1, pixelX, pixelY);
    DstPlaneLumaT *pixelOutLuma2    = gotoPtr(aDst1, aPitchDst1, pixelX, pixelY + 1);
    DstPlaneChromaT *pixelOutChroma = gotoPtr(aDst2, aPitchDst2, pixelXChroma, pixelYChroma);
    ...
    Tupel<DstPlaneLumaT, subSampleSize> resLuma[subSampleSize];
#pragma unroll
...
#pragma unroll
    ...
    Tupel<DstPlaneLumaT, subSampleSize>::Store(resLuma[0], pixelOutLuma1);
    Tupel<DstPlaneLumaT, subSampleSize>::Store(resLuma[1], pixelOutLuma2);
...
void InvokeForEachPixel420Planar2Kernel(const dim3 &aBlockSize, cudaStream_t aStream,
                                        ...
                                        ChromaSubsamplePos chromaSubsamplePos)
{
    ...
    {
        forEachPixel420Planar2Kernel<DstT, funcType, ChromaSubsamplePos::Center>
    ...
    {
        forEachPixel420Planar2Kernel<DstT, funcType, ChromaSubsamplePos::Left>
            <<<blocksPerGrid, aBlockSize, 0, aStream>>>(aDst1, aPitchDst1, aDst2, aPitchDst2, aSize, aFunctor);
    }
    else
    {
        forEachPixel420Planar2Kernel<DstT, funcType, ChromaSubsamplePos::TopLeft>
            <<<blocksPerGrid, aBlockSize, 0, aStream>>>(aDst1, aPitchDst1, aDst2, aPitchDst2, aSize, aFunctor);
    }
...
template <typename DstT, typename funcType>
void InvokeForEachPixel420Planar2KernelDefault(Vector1<remove_vector_t<DstT>> *__restrict__ aDst1, size_t aPitchDst1,
                                               Vector2<remove_vector_t<DstT>> *__restrict__ aDst2, size_t aPitchDst2,
                                               ...
                                               const mpp::cuda::StreamCtx &aStreamCtx, const funcType &aFunc)
{
    if (aStreamCtx.ComputeCapabilityMajor < INT_MAX)
    {
        ...
        InvokeForEachPixel420Planar2Kernel<DstT, funcType>(BlockSize, aStreamCtx.Stream, aDst1, aPitchDst1, aDst2,
                                                           aPitchDst2, aSize, aFunc, chromaSubsamplePos);
    }
    else
    {
        throw CUDAUNSUPPORTED(forEachPixel420Planar2Kernel,
