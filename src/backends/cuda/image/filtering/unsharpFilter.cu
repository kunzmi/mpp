...
void InvokeUnsharpFilter(const SrcT *aSrc1, size_t aPitchSrc1, DstT *aDst, size_t aPitchDst, const FilterT *aFilter,
...
#define Instantiate_For(typeSrcIsTypeDst, typeFilter)                                                                  \
    template void InvokeUnsharpFilter<typeSrcIsTypeDst, typeSrcIsTypeDst, typeFilter>(                                 \
