                        ...
                        const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    switch (aBorderType)
    {
        case mpp::BorderType::None:
        {
            ...
            InvokeWienerFilterKernelDefault<ComputeT, DstT, TupelSize, pixelBlockSizeY, RoundingMode::NearestTiesToEven,
                                            BCType>(bc, aDst, aPitchDst, aFilterArea, aNoise, aSize, aStreamCtx);
        }
        break;
