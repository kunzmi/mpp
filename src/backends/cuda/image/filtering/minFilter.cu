...
void InvokeMinFilter(const SrcT *aSrc1, size_t aPitchSrc1, DstT *aDst, size_t aPitchDst, const FilterArea &aFilterArea,
...
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void InvokeMinFilter<typeSrcIsTypeDst, typeSrcIsTypeDst>(                                                 \
