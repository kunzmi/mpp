...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeCannyEdgeMaxSupression<typeSrc, typeDst>(                                                      \
        const typeSrc *aSrc1, size_t aPitchSrc1, const Pixel32fC1 *aSrcAngle, size_t aPitchSrcAngle, typeDst *aDst,    \
        size_t aPitchDst, typeSrc aLowThreshold, typeSrc aHighThreshold, const Size2D &aAllowedReadRoiSize,            \
