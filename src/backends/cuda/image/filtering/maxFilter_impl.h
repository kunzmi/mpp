...
void InvokeMaxFilter(const SrcT *aSrc1, size_t aPitchSrc1, DstT *aDst, size_t aPitchDst, const FilterArea &aFilterArea,
                     ...
                     const mpp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (mppEnablePixelType<DstT> && mppEnableCudaBackend<DstT>)
    {
        ...
        using ComputeT                       = SrcT;
        using WindowOpT                      = mpp::Max<ComputeT>;
...
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void InvokeMaxFilter<typeSrcIsTypeDst, typeSrcIsTypeDst>(                                                 \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, typeSrcIsTypeDst *aDst, size_t aPitchDst,                    \
        const FilterArea &aFilterArea, BorderType aBorderType, const typeSrcIsTypeDst &aConstant,                      \
