...
void InvokeSobelVertSecond(const SrcT *aSrc1, size_t aPitchSrc1, DstT *aDst, size_t aPitchDst, MaskSize aMaskSize,
                           ...
                           const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    switch (aMaskSize)
    {
        case MaskSize::Mask_3x3:
        {
            ...
            using FixedFilterKernelT = FixedFilterKernel<mpp::FixedFilter::SobelVertSecond, filterSize, FilterT>;
            ...
            switch (aBorderType)
            {
                ...
                default:
                    throw INVALIDARGUMENT(
                        aBorderType, aBorderType << " is not a supported border type mode for SobelVertSecond filter.");
                    break;
            }
        }
        break;
        ...
        break;
        default:
            throw INVALIDARGUMENT(aMaskSize, "Invalid MaskSize for SobelVertSecond filter: " << aMaskSize);
            break;
    }
}
...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeSobelVertSecond<typeSrc, typeDst>(                                                             \
