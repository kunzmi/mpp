                      ...
                      const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    switch (aMaskSize)
    {
            ...
            switch (aBorderType)
            {
                ...
                default:
                    throw INVALIDARGUMENT(aBorderType,
                                          aBorderType << " is not a supported border type mode for GaussFixed filter.");
                    break;
            }
        }
        break;
            ...
            switch (aBorderType)
            {
                case mpp::BorderType::None:
                {
                    ...
                    InvokeFixedSeparableFilterKernelDefault<ComputeT, DstT, TupelSize, filterSize, pixelBlockSizeY,
                                                            ...
                                                            FixedFilterKernelT>(bc, aDst, aPitchDst, aSize, aStreamCtx);
                }
                break;
                case mpp::BorderType::Constant:
                {
        ...
        break;
        default:
            throw INVALIDARGUMENT(aMaskSize, "Invalid MaskSize for GaussFixed filter: " << aMaskSize);
            break;
    }
}
