...
void InvokeFixedSizeDilation(const SrcT *aSrc1, size_t aPitchSrc1, DstT *aDst, size_t aPitchDst, const Pixel8uC1 *aMask,
...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeFixedSizeDilation<typeSrc, typeDst>(                                                           \
