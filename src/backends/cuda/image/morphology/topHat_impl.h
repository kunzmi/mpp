...
void InvokeTopHat(const SrcT *aSrcFromErode, size_t aPitchSrcFromErode, const SrcT *aSrcOrig, size_t aPitchSrcOrig,
    ...
    if constexpr (mppEnablePixelType<DstT> && mppEnableCudaBackend<DstT>)
    {
        ...
        switch (aBorderType)
        {
            ...
            case mpp::BorderType::Constant:
            {
                ...
                const BCType bc(aSrcFromErode, aPitchSrcFromErode, aAllowedReadRoiSize, aOffsetToActualRoi, aConstant);
            ...
            break;
            default:
                throw INVALIDARGUMENT(aBorderType, aBorderType << " is not a supported border type mode for TopHat.");
                break;
        }
    }
}
...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeTopHat<typeSrc, typeDst>(                                                                      \
        const typeSrc *aSrcFromErode, size_t aPitchSrcFromErode, const typeSrc *aSrcOrig, size_t aPitchSrcOrig,        \
        typeDst *aDst, size_t aPitchDst, const Pixel8uC1 *aMask, const FilterArea &aFilterArea,                        \
