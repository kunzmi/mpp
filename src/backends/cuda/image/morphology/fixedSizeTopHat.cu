...
#include <backends/cuda/image/fixedSizeMorphologyKernel.h>
...
void InvokeFixedSizeTopHat(const SrcT *aSrcFromErode, size_t aPitchSrcFromErode, const SrcT *aSrcOrig,
                           size_t aPitchSrcOrig, DstT *aDst, size_t aPitchDst, const Pixel8uC1 *aMask,
...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeFixedSizeTopHat<typeSrc, typeDst>(                                                             \
        const typeSrc *aSrcFromErode, size_t aPitchSrcFromErode, const typeSrc *aSrcOrig, size_t aPitchSrcOrig,        \
        typeDst *aDst, size_t aPitchDst, const Pixel8uC1 *aMask, MaskSize aMaskSize,                                   \
