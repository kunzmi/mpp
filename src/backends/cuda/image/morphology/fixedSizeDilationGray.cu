...
void InvokeFixedSizeDilationGray(const SrcT *aSrc1, size_t aPitchSrc1, DstT *aDst, size_t aPitchDst,
                                 ...
                                 const Size2D &aSize, const opp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        using MorphOp              = opp::DilateGray<DstT, FilterT>;
...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeFixedSizeDilationGray<typeSrc, typeDst>(                                                       \
        const typeSrc *aSrc1, size_t aPitchSrc1, typeDst *aDst, size_t aPitchDst,                                      \
        const morph_gray_compute_type_t<typeSrc> *aMask, MaskSize aMaskSize, const Vector2<int> &aFilterCenter,        \
