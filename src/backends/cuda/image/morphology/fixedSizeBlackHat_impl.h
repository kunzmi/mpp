...
void InvokeFixedSizeBlackHat(const SrcT *aSrcFromErode, size_t aPitchSrcFromErode, const SrcT *aSrcOrig,
...
#define Instantiate_For(typeSrc, typeDst)                                                                              \
    template void InvokeFixedSizeBlackHat<typeSrc, typeDst>(                                                           \
