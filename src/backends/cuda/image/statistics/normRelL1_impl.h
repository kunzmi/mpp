...
void InvokeNormRelL1SrcSrc(const SrcT *aSrc1, size_t aPitchSrc1, const SrcT *aSrc2, size_t aPitchSrc2,
                           ...
                           const mpp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (mppEnablePixelType<SrcT> && mppEnableCudaBackend<SrcT>)
    {
        ...
        using normL1SrcSrc = SrcSrcReduction2Functor<TupelSize, SrcT, ComputeT, ComputeT,
                                                     mpp::NormRelL1<SrcT, ComputeT>, mpp::NormL1<SrcT, ComputeT>>;
        ...
        InvokeReduction2AlongXKernelDefault<SrcT, ComputeT, ComputeT, TupelSize, normL1SrcSrc,
        ...
        InvokeReduction2AlongYKernelDefault<ComputeT, ComputeT, DstT, DstT, mpp::Sum<DstT, DstT>, mpp::Sum<DstT, DstT>,
                                            ...
                                            mpp::NormRelL1Post<DstT>, mpp::NothingScalar<DstT>,
                                            mpp::NormRelL1Post<DstT>>(
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void InvokeNormRelL1SrcSrc<typeSrc, normRelL1_types_for_ct<typeSrc>, normRelL1_types_for_rt<typeSrc>>(    \
        const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2, size_t aPitchSrc2,                              \
        normRelL1_types_for_ct<typeSrc> *aTemp1, normRelL1_types_for_ct<typeSrc> *aTemp2,                              \
