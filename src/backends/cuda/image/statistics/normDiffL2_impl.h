...
void InvokeNormDiffL2SrcSrc(const SrcT *aSrc1, size_t aPitchSrc1, const SrcT *aSrc2, size_t aPitchSrc2,
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void InvokeNormDiffL2SrcSrc<typeSrc, normDiffL2_types_for_ct<typeSrc>, normDiffL2_types_for_rt<typeSrc>>( \
        const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2, size_t aPitchSrc2,                              \
        normDiffL2_types_for_ct<typeSrc> *aTemp, normDiffL2_types_for_rt<typeSrc> *aDst,                               \
