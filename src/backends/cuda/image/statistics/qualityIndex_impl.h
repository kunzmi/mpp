                              ...
                              const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    InvokeReduction5AlongXKernelDefault<
        ...
        mpp::Sum<ComputeT, ComputeT>, mpp::Sum<ComputeT, ComputeT>, ReductionInitValue::Zero, ReductionInitValue::Zero,
        ReductionInitValue::Zero, ReductionInitValue::Zero, ReductionInitValue::Zero>(
    ...
    InvokeReduction5AlongYKernelDefault<ComputeT, ComputeT, ComputeT, ComputeT, ComputeT, ComputeT2, ComputeT2,
                                        ComputeT2, ComputeT2, ComputeT2, DstT, mpp::Sum<ComputeT2, ComputeT2>,
                                        mpp::Sum<ComputeT2, ComputeT2>, mpp::Sum<ComputeT2, ComputeT2>,
                                        mpp::Sum<ComputeT2, ComputeT2>, mpp::Sum<ComputeT2, ComputeT2>,
                                        ReductionInitValue::Zero, ReductionInitValue::Zero, ReductionInitValue::Zero,
                                        ReductionInitValue::Zero, ReductionInitValue::Zero, mpp::QualityIndex<DstT>>(
        aTempBuffer1, aTempBuffer2, aTempBuffer3, aTempBuffer4, aTempBuffer5, aDst, aSize.y, postOp, aStreamCtx);
}
