...
void InvokeMaxRelativeErrorMaskedSrcSrc(const Pixel8uC1 *aMask, size_t aPitchMask, const SrcT *aSrc1, size_t aPitchSrc1,
                                        ...
                                        const opp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<SrcT> && oppEnableCudaBackend<SrcT>)
    {
        ...
        using avgErrorSrcSrc =
            SrcSrcReductionFunctor<TupelSize, SrcT, ComputeT, opp::MaximumRelativeError<SrcT, ComputeT>>;

        const opp::MaximumRelativeError<SrcT, ComputeT> op;

        const avgErrorSrcSrc functor(aSrc1, aPitchSrc1, aSrc2, aPitchSrc2, op);

        InvokeReductionMaskedAlongXKernelDefault<SrcT, ComputeT, TupelSize, avgErrorSrcSrc, opp::MaxRed<ComputeT>,
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void InvokeMaxRelativeErrorMaskedSrcSrc<typeSrc, maxRelativeError_types_for_ct<typeSrc>,                  \
        ...
        size_t aPitchSrc2, maxRelativeError_types_for_ct<typeSrc> *aTemp,                                              \
        maxRelativeError_types_for_rt<typeSrc> *aDst,                                                                  \
