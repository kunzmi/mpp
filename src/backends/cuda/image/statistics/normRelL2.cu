...
void InvokeNormRelL2SrcSrc(const SrcT *aSrc1, size_t aPitchSrc1, const SrcT *aSrc2, size_t aPitchSrc2,
                           ...
                           const opp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<SrcT> && oppEnableCudaBackend<SrcT>)
    {
        ...
        using normL2SrcSrc = SrcSrcReduction2Functor<TupelSize, SrcT, ComputeT, ComputeT,
                                                     opp::NormRelL2<SrcT, ComputeT>, opp::NormL2<SrcT, ComputeT>>;
        ...
        InvokeReduction2AlongYKernelDefault<ComputeT, ComputeT, DstT, DstT, opp::Sum<DstT, DstT>, opp::Sum<DstT, DstT>,
                                            ...
                                            opp::NormRelL2Post<DstT>, opp::NothingScalar<DstT>,
                                            opp::NormRelL2Post<DstT>>(
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void InvokeNormRelL2SrcSrc<typeSrc, normRelL2_types_for_ct<typeSrc>, normRelL2_types_for_rt<typeSrc>>(    \
        const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2, size_t aPitchSrc2,                              \
        normRelL2_types_for_ct<typeSrc> *aTemp1, normRelL2_types_for_ct<typeSrc> *aTemp2,                              \
