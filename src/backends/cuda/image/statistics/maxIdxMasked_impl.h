...
#define Instantiate_For(type)                                                                                          \
    template void InvokeMaxIdxMaskedSrc<type>(                                                                         \
        const Pixel8uC1 *aMask, size_t aPitchMask, const type *aSrc, size_t aPitchSrc, type *aTempBufferMax,           \
        ...
        same_vector_size_different_type_t<type, int> *aDstMaxIdxY, remove_vector_t<type> *aDstScalarMax,               \
