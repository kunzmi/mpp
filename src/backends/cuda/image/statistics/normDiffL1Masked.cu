...
void InvokeNormDiffL1MaskedSrcSrc(const Pixel8uC1 *aMask, size_t aPitchMask, const SrcT *aSrc1, size_t aPitchSrc1,
                                  ...
                                  const opp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<SrcT> && oppEnableCudaBackend<SrcT>)
    {
        ...
        InvokeReductionMaskedAlongXKernelDefault<SrcT, ComputeT, TupelSize, normL1SrcSrc, opp::Sum<ComputeT, ComputeT>,
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void                                                                                                      \
    InvokeNormDiffL1MaskedSrcSrc<typeSrc, normDiffL1_types_for_ct<typeSrc>, normDiffL1_types_for_rt<typeSrc>>(         \
        const Pixel8uC1 *aMask, size_t aPitchMask, const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2,      \
        size_t aPitchSrc2, normDiffL1_types_for_ct<typeSrc> *aTemp, normDiffL1_types_for_rt<typeSrc> *aDst,            \
