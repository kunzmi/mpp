...
void InvokeMSEMaskedSrcSrc(const Pixel8uC1 *aMask, size_t aPitchMask, const SrcT *aSrc1, size_t aPitchSrc1,
                           ...
                           const opp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<SrcT> && oppEnableCudaBackend<SrcT>)
    {
        ...
        InvokeReductionMaskedCountingAlongXKernelDefault<SrcT, ComputeT, TupelSize, normL2SrcSrc,
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void InvokeMSEMaskedSrcSrc<typeSrc, mse_types_for_ct<typeSrc>, mse_types_for_rt<typeSrc>>(                \
        const Pixel8uC1 *aMask, size_t aPitchMask, const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2,      \
        size_t aPitchSrc2, mse_types_for_ct<typeSrc> *aTemp, ulong64 *aMaskBuffer, mse_types_for_rt<typeSrc> *aDst,    \
