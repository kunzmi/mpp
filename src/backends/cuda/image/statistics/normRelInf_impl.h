                            ...
                            const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    InvokeReduction2AlongXKernelDefault<SrcT, ComputeT, ComputeT, TupelSize, normInfSrcSrc, mpp::MaxRed<ComputeT>,
                                        mpp::MaxRed<ComputeT>, ReductionInitValue::Zero, ReductionInitValue::Zero>(
    ...
    InvokeReduction2AlongYKernelDefault<ComputeT, ComputeT, DstT, DstT, mpp::MaxRed<DstT>, mpp::MaxRed<DstT>,
                                        ...
                                        mpp::NormRelInfPost<DstT>, mpp::NothingScalar<DstT>, mpp::NormRelInfPost<DstT>>(
