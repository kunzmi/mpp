                            ...
                            const opp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<SrcT> && oppEnableCudaBackend<SrcT>)
    {
        ...
        using normInfSrcSrc = SrcSrcReduction2Functor<TupelSize, SrcT, ComputeT, ComputeT,
                                                      opp::NormRelInf<SrcT, ComputeT>, opp::NormInf<SrcT, ComputeT>>;
        ...
        InvokeReduction2AlongXKernelDefault<SrcT, ComputeT, ComputeT, TupelSize, normInfSrcSrc, opp::MaxRed<ComputeT>,
                                            opp::MaxRed<ComputeT>, ReductionInitValue::Zero, ReductionInitValue::Zero>(
        ...
        InvokeReduction2AlongYKernelDefault<ComputeT, ComputeT, DstT, DstT, opp::MaxRed<DstT>, opp::MaxRed<DstT>,
                                            ReductionInitValue::Zero, ReductionInitValue::Zero, opp::Nothing<DstT>,
                                            opp::NormRelInfPost<DstT>, opp::NothingScalar<DstT>,
                                            opp::NormRelInfPost<DstT>>(
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void InvokeNormRelInfSrcSrc<typeSrc, normRelInf_types_for_ct<typeSrc>, normRelInf_types_for_rt<typeSrc>>( \
        const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2, size_t aPitchSrc2,                              \
        normRelInf_types_for_ct<typeSrc> *aTemp1, normRelInf_types_for_ct<typeSrc> *aTemp2,                            \
