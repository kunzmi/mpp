...
void InvokeNormDiffInfMaskedSrcSrc(const Pixel8uC1 *aMask, size_t aPitchMask, const SrcT *aSrc1, size_t aPitchSrc1,
                                   ...
                                   const mpp::cuda::StreamCtx &aStreamCtx)
{
    if constexpr (mppEnablePixelType<SrcT> && mppEnableCudaBackend<SrcT>)
    {
        ...
        InvokeReductionMaskedAlongXKernelDefault<SrcT, ComputeT, TupelSize, normInfSrcSrc, mpp::MaxRed<ComputeT>,
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void                                                                                                      \
    InvokeNormDiffInfMaskedSrcSrc<typeSrc, normDiffInf_types_for_ct<typeSrc>, normDiffInf_types_for_rt<typeSrc>>(      \
        const Pixel8uC1 *aMask, size_t aPitchMask, const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2,      \
        size_t aPitchSrc2, normDiffInf_types_for_ct<typeSrc> *aTemp, normDiffInf_types_for_rt<typeSrc> *aDst,          \
