...
void InvokeDotProductMaskedSrcSrc(const Pixel8uC1 *aMask, size_t aPitchMask, const SrcT *aSrc1, size_t aPitchSrc1,
                                  ...
                                  const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    InvokeReductionMaskedAlongXKernelDefault<SrcT, ComputeT, TupelSize, dotProdSrcSrc, mpp::Sum<ComputeT, ComputeT>,
...
#define Instantiate_For(typeSrc)                                                                                       \
    template void                                                                                                      \
    InvokeDotProductMaskedSrcSrc<typeSrc, dotProduct_types_for_ct<typeSrc>, dotProduct_types_for_rt<typeSrc>>(         \
        const Pixel8uC1 *aMask, size_t aPitchMask, const typeSrc *aSrc1, size_t aPitchSrc1, const typeSrc *aSrc2,      \
        size_t aPitchSrc2, dotProduct_types_for_ct<typeSrc> *aTemp, dotProduct_types_for_rt<typeSrc> *aDst,            \
