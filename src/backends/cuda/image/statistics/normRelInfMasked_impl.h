                                  ...
                                  const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    InvokeReduction2MaskedAlongXKernelDefault<SrcT, ComputeT, ComputeT, TupelSize, normInfSrcSrc, mpp::MaxRed<ComputeT>,
                                              mpp::MaxRed<ComputeT>, ReductionInitValue::Zero,
                                              ReductionInitValue::Zero>(aMask, aPitchMask, aSrc1, aTempBuffer1,
                                                                        aTempBuffer2, aSize, aStreamCtx, functor);
