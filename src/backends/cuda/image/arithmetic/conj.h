...
template <typename DstT, typename ComputeT = DstT>
void InvokeConjInplace(DstT *aSrcDst, size_t aPitchSrcDst, const Size2D &aSize, const opp::cuda::StreamCtx &aStreamCtx);
