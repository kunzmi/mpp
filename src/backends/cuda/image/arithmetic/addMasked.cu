                         ...
                         const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        if constexpr (simdOP_t::has_simd)
        {
            ...
            addSrcSrcSIMD functor(aSrc1, aPitchSrc1, aSrc2, aPitchSrc2, op, opSIMD);
        ...
        else
        {
            ...
            addSrcSrc functor(aSrc1, aPitchSrc1, aSrc2, aPitchSrc2, op);
...
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void InvokeAddSrcSrcMask<typeSrcIsTypeDst, add_compute_type_for_t<typeSrcIsTypeDst>, typeSrcIsTypeDst>(   \
                              ...
                              scalefactor_t<ComputeT> aScaleFactor, const Size2D &aSize, const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addSrcSrcScale functor(aSrc1, aPitchSrc1, aSrc2, aPitchSrc2, op, aScaleFactor);
                       ...
                       const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        else
        {
            ...
            addSrcC functor(aSrc, aPitchSrc, static_cast<ComputeT>(aConst), op);
...
// using add_compute_type_for_t for computeT including SIMD activation if possible
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void InvokeAddSrcCMask<typeSrcIsTypeDst, add_compute_type_for_t<typeSrcIsTypeDst>, typeSrcIsTypeDst>(     \
                            ...
                            const Size2D &aSize, const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addSrcCScale functor(aSrc, aPitchSrc, static_cast<ComputeT>(aConst), op, aScaleFactor);
                          ...
                          const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addSrcDevC functor(aSrc, aPitchSrc, aConst, op);
                               ...
                               const Size2D &aSize, const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addSrcDevCScale functor(aSrc, aPitchSrc, aConst, op, aScaleFactor);
                             ...
                             const SrcT *aSrc2, size_t aPitchSrc2, const Size2D &aSize, const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        if constexpr (simdOP_t::has_simd)
        {
            ...
            addInplaceSrcSIMD functor(aSrc2, aPitchSrc2, op, opSIMD);
        ...
        else
        {
            ...
            addInplaceSrc functor(aSrc2, aPitchSrc2, op);
...
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void                                                                                                      \
    InvokeAddInplaceSrcMask<typeSrcIsTypeDst, add_compute_type_for_t<typeSrcIsTypeDst>, typeSrcIsTypeDst>(             \
                                  ...
                                  const Size2D &aSize, const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addInplaceSrcScale functor(aSrc2, aPitchSrc2, op, aScaleFactor);
...
// using add_compute_type_for_t for computeT including SIMD activation if possible
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void InvokeAddInplaceCMask<typeSrcIsTypeDst, add_compute_type_for_t<typeSrcIsTypeDst>, typeSrcIsTypeDst>( \
        const Pixel8uC1 *aMask, size_t aPitchMask, typeSrcIsTypeDst *aSrcDst, size_t aPitchSrcDst,                     \
                                ...
                                const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addInplaceCScale functor(static_cast<ComputeT>(aConst), op, aScaleFactor);
                              ...
                              const SrcT *aConst, const Size2D &aSize, const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addInplaceDevC functor(aConst, op);
...
#define Instantiate_For(typeSrcIsTypeDst)                                                                              \
    template void                                                                                                      \
    InvokeAddInplaceDevCMask<typeSrcIsTypeDst, add_compute_type_for_t<typeSrcIsTypeDst>, typeSrcIsTypeDst>(            \
        const Pixel8uC1 *aMask, size_t aPitchMask, typeSrcIsTypeDst *aSrcDst, size_t aPitchSrcDst,                     \
        const typeSrcIsTypeDst *aConst, const Size2D &aSize, const StreamCtx &aStreamCtx);
                                   ...
                                   const StreamCtx &aStreamCtx)
{
    if constexpr (oppEnablePixelType<DstT> && oppEnableCudaBackend<DstT>)
    {
        ...
        addInplaceDevCScale functor(aConst, op, aScaleFactor);
