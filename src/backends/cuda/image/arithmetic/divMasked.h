...
void InvokeDivSrcCScaleMask(const Pixel8uC1 *aMask, size_t aPitchMask, const SrcT *aSrc, size_t aPitchSrc,
                            const SrcT &aConst, DstT *aDst, size_t aPitchDst, scalefactor_t<ComputeT> aScaleFactor, mpp::RoundingMode aRoundingMode,
...
void InvokeDivInplaceSrcScaleMask(const Pixel8uC1 *aMask, size_t aPitchMask, DstT *aSrcDst, size_t aPitchSrcDst,
                                  const SrcT *aSrc2, size_t aPitchSrc2, scalefactor_t<ComputeT> aScaleFactor, mpp::RoundingMode aRoundingMode,
                                  const Size2D &aSize, const mpp::cuda::StreamCtx &aStreamCtx);
...
void InvokeDivInplaceCScaleMask(const Pixel8uC1 *aMask, size_t aPitchMask, DstT *aSrcDst, size_t aPitchSrcDst,
                                const SrcT &aConst, scalefactor_t<ComputeT> aScaleFactor, mpp::RoundingMode aRoundingMode, const Size2D &aSize,
                                const mpp::cuda::StreamCtx &aStreamCtx);
