...
template <int WarpAlignmentInBytes, int TupelSize, class ComputeT, class DstT, int blockHeight,
          RoundingMode roundingMode, typename BorderControlT, typename FilterT, bool needsScaling, int filterSize>
__global__ void fixedSizeSeparableFilterKernel(BorderControlT aSrcWithBC, DstT *__restrict__ aDst, size_t aPitchDst,
...
template <typename ComputeT, typename DstT, size_t TupelSize, int WarpAlignmentInBytes, int blockHeight,
          RoundingMode roundingMode, typename BorderControlT, typename FilterT, bool needsScaling, int filterSize>
void InvokeFixedSizeSeparableFilterKernel(const dim3 &aBlockSize, uint aSharedMemory, int aWarpSize,
                                          ...
                                          int aFilterCenter, const Size2D &aSize)
{
    ...
    fixedSizeSeparableFilterKernel<WarpAlignmentInBytes, TupelSize, ComputeT, DstT, blockHeight, roundingMode,
                                   BorderControlT, FilterT, needsScaling, filterSize>
...
void InvokeFixedSizeSeparableFilterKernelDefault(const BorderControlT &aSrcWithBC, DstT *aDst, size_t aPitchDst,
                                                 ...
                                                 const opp::cuda::StreamCtx &aStreamCtx)
{
    if (aStreamCtx.ComputeCapabilityMajor < INT_MAX)
    {
        ...
        {
            case 3:
                InvokeFixedSizeSeparableFilterKernel<ComputeT, DstT, TupelSize, WarpAlignmentInBytes, blockHeight,
                                                     roundingMode, BorderControlT, FilterT, needsScaling, 3>(
                    BlockSize, SharedMemory, aStreamCtx.WarpSize, aStreamCtx.Stream, aSrcWithBC, aDst, aPitchDst,
                    aFilter, aScalingValueInv, aFilterCenter, aSize);
                break;
            case 5:
                InvokeFixedSizeSeparableFilterKernel<ComputeT, DstT, TupelSize, WarpAlignmentInBytes, blockHeight,
                                                     roundingMode, BorderControlT, FilterT, needsScaling, 5>(
                    BlockSize, SharedMemory, aStreamCtx.WarpSize, aStreamCtx.Stream, aSrcWithBC, aDst, aPitchDst,
                    aFilter, aScalingValueInv, aFilterCenter, aSize);
                break;
            case 7:
                InvokeFixedSizeSeparableFilterKernel<ComputeT, DstT, TupelSize, WarpAlignmentInBytes, blockHeight,
                                                     roundingMode, BorderControlT, FilterT, needsScaling, 7>(
                    BlockSize, SharedMemory, aStreamCtx.WarpSize, aStreamCtx.Stream, aSrcWithBC, aDst, aPitchDst,
                    aFilter, aScalingValueInv, aFilterCenter, aSize);
                break;
            case 9:
                InvokeFixedSizeSeparableFilterKernel<ComputeT, DstT, TupelSize, WarpAlignmentInBytes, blockHeight,
                                                     roundingMode, BorderControlT, FilterT, needsScaling, 9>(
                    BlockSize, SharedMemory, aStreamCtx.WarpSize, aStreamCtx.Stream, aSrcWithBC, aDst, aPitchDst,
                    aFilter, aScalingValueInv, aFilterCenter, aSize);
                break;
            default:
    ...
    {
        throw CUDAUNSUPPORTED(fixedSizeSeparableFilterKernel,
