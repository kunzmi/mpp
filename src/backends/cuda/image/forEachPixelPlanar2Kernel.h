...
{
/// <summary>
/// runs aFunctor on every pixel of an image. Inplace and outplace operation, no mask. Planar 2 channel destination, for
/// Tupled operation, both Dst-pointers must fulfill the same alignment constraints.
/// </summary>
template <int WarpAlignmentInBytes, int TupelSize, class DstT, typename funcType>
__global__ void forEachPixelPlanar2Kernel(Vector1<remove_vector_t<DstT>> *__restrict__ aDst1, size_t aPitchDst1,
                                     ...
                                     const Size2D &aSize, const funcType &aFunctor)
{
    ...
    forEachPixelPlanar2Kernel<WarpAlignmentInBytes, TupelSize, DstT, funcType>
        <<<blocksPerGrid, aBlockSize, aSharedMemory, aStream>>>(aDst1, aPitchDst1, aDst2, aPitchDst2, aSize, ts,
                                                                aFunctor);
...
void InvokeForEachPixelPlanar2KernelDefault(Vector1<remove_vector_t<DstT>> *__restrict__ aDst1, size_t aPitchDst1,
                                            Vector1<remove_vector_t<DstT>> *__restrict__ aDst2, size_t aPitchDst2,
                                            ...
                                            const funcType &aFunc)
{
    ...
    {
        throw CUDAUNSUPPORTED(forEachPixelPlanar2Kernel,
