                            ...
                            const Matrix<float> &aTwist, const Size2D &aSize, const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    using colorTwistSrc =
        SrcFunctor<TupelSize, SrcT, ComputeT, DstT, mpp::image::ColorTwist3x3<ComputeT>, GetRoundingMode<DstT>()>;
...
#define InstantiateInvokeColorTwist3x3Src_For(typeSrcIsTypeDst)                                                        \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, typeSrcIsTypeDst *aDst, size_t aPitchDst,                    \
        const Matrix<float> &aTwist, const Size2D &aSize, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src(type)                                                            \
    InstantiateInvokeColorTwist3x3Src_For(Pixel##type##C3);                                                            \
    InstantiateInvokeColorTwist3x3Src_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3P3Src_For(typeSrcIsTypeDst)                                                      \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
        ...
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst3, size_t aPitchDst3, const Matrix<float> &aTwist,             \
        const Size2D &aSize, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3P3Src(type)                                                          \
    InstantiateInvokeColorTwist3x3P3Src_For(Pixel##type##C3);                                                          \
    InstantiateInvokeColorTwist3x3P3Src_For(Pixel##type##C4A);
                            ...
                            const Size2D &aSize, const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    using colorTwistSrc =
        SrcFunctor<TupelSize, SrcT, ComputeT, DstT,
                   mpp::image::SetAlpha<ComputeT, mpp::image::ColorTwist3x3<Pixel32fC4A>>, GetRoundingMode<DstT>()>;
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3P4Src_For(typeSrcIsTypeDst)                                                      \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst3, size_t aPitchDst3,                                          \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst4, size_t aPitchDst4, const Matrix<float> &aTwist,             \
        const Size2D &aSize, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3P4Src(type) InstantiateInvokeColorTwist3x3P4Src_For(Pixel##type##C4);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3P3SrcP3_For(typeSrcIsTypeDst)                                                    \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3P3SrcP3(type)                                                        \
    InstantiateInvokeColorTwist3x3P3SrcP3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3_For(typeSrcIsTypeDst)                                                      \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3, typeSrcIsTypeDst *aDst1,           \
        size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3(type)                                                          \
    InstantiateInvokeColorTwist3x3SrcP3_For(Pixel##type##C3);                                                          \
    InstantiateInvokeColorTwist3x3SrcP3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3C4SrcP3_For(typeSrcIsTypeDst)                                                    \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3, typeSrcIsTypeDst *aDst1,           \
        size_t aPitchDst1, remove_vector_t<typeSrcIsTypeDst> aAlpha, const Matrix<float> &aTwist, const Size2D &aSize, \
        const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3C4SrcP3(type)                                                        \
    InstantiateInvokeColorTwist3x3C4SrcP3_For(Pixel##type##C4);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP4_For(typeSrcIsTypeDst)                                                      \
    template void InvokeColorTwist3x3Src<typeSrcIsTypeDst>(                                                            \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP4(type) InstantiateInvokeColorTwist3x3SrcP4_For(Pixel##type##C4);
                                ...
                                const Size2D &aSize, const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    using colorTwistInplace =
        InplaceFunctor<TupelSize, ComputeT, DstT, mpp::image::ColorTwist3x3<ComputeT>, GetRoundingMode<DstT>()>;
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Inplace_For(typeSrcIsTypeDst)                                                    \
    template void InvokeColorTwist3x3Inplace<typeSrcIsTypeDst>(typeSrcIsTypeDst * aSrcDst1, size_t aPitchSrcDst1,      \
                                                               const Matrix<float> &aTwist, const Size2D &aSize,       \
                                                               const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Inplace(type)                                                        \
    InstantiateInvokeColorTwist3x3Inplace_For(Pixel##type##C3);                                                        \
    InstantiateInvokeColorTwist3x3Inplace_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to422C2_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to422<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector2<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,   \
        bool aSwapLumaChroma, const mpp::cuda::StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to422C2(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to422C2_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to422C2_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to422C2_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to422<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
        Vector2<remove_vector_t<typeSrcIsTypeDst>> *aDst1, size_t aPitchDst1, const Matrix<float> &aTwist,             \
        const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos, bool aSwapLumaChroma,                             \
        const mpp::cuda::StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to422C2(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to422C2_For(Pixel##type##C3);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to422P2_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to422<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector2<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,                      \
        const mpp::cuda::StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to422P2(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to422P2_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to422P2_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to422P3_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to422<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst3, size_t aPitchDst3, const Matrix<float> &aTwist,             \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to422P3(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to422P3_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to422P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to422P2_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to422<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1, size_t aPitchDst1,                                          \
        Vector2<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2, const Matrix<float> &aTwist,             \
        const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos, const mpp::cuda::StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to422P2(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to422P2_For(Pixel##type##C3);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to422P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to422<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to422P3(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to422P3_For(Pixel##type##C3);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to420P2_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to420<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector2<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,                      \
        const mpp::cuda::StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to420P2(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to420P2_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to420P2_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to420P3_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to420<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst3, size_t aPitchDst3, const Matrix<float> &aTwist,             \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to420P3(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to420P3_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to420P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to420P2_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to420<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to420P2(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to420P2_For(Pixel##type##C3);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to420P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to420<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to420P3(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to420P3_For(Pixel##type##C3);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to411P2_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to411<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector2<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,                      \
        const mpp::cuda::StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to411P2(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to411P2_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to411P2_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src444to411P3_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src444to411<typeSrcIsTypeDst>(                                                    \
        const typeSrcIsTypeDst *aSrc1, size_t aPitchSrc1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1,           \
        size_t aPitchDst1, Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst2, size_t aPitchDst2,                       \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst3, size_t aPitchDst3, const Matrix<float> &aTwist,             \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src444to411P3(type)                                                  \
    InstantiateInvokeColorTwist3x3Src444to411P3_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src444to411P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to411P2_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to411<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to411P2(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to411P2_For(Pixel##type##C3);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3SrcP3444to411P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src444to411<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3SrcP3444to411P3(type)                                                \
    InstantiateInvokeColorTwist3x3SrcP3444to411P3_For(Pixel##type##C3);

#pragma endregion

template <typename SrcDstT>
void InvokeColorTwist3x3Src422to444(const Vector2<remove_vector_t<SrcDstT>> *aSrc1, size_t aPitchSrc1, SrcDstT *aDst1,
                                    size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize,
                                    bool aSwapLumaChroma, const mpp::cuda::StreamCtx &aStreamCtx)
{
    using SrcT     = SrcDstT;
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src422C2to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src422to444<typeSrcIsTypeDst>(                                                    \
        const Vector2<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1, typeSrcIsTypeDst *aDst1,           \
        size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize, bool aSwapLumaChroma,                     \
        const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src422C2to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src422C2to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src422C2to444_For(Pixel##type##C4A);
                                    ...
                                    const mpp::cuda::StreamCtx &aStreamCtx)
{
        ...
        switch (aInterpolationMode)
        {
            ...
            case InterpolationMode::Linear:
            {
                using colorTwistSrc = Src422Functor<TupelSize, SrcT, ComputeT, DstT,
                                                    mpp::image::ColorTwist3x3<ComputeT>, ChromaSubsamplePos::Left,
    ...
    else // Undefined or Center
    {
        switch (aInterpolationMode)
        {
            ...
            {
                using colorTwistSrc = Src422Functor<TupelSize, SrcT, ComputeT, DstT,
                                                    mpp::image::ColorTwist3x3<ComputeT>, ChromaSubsamplePos::Center,
                                                    InterpolationMode::Linear, false, false, GetRoundingMode<DstT>()>;
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src422P2to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src422to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector2<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2, typeSrcIsTypeDst *aDst1,           \
        size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,   \
        InterpolationMode aInterpolationMode, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src422P2to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src422P2to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src422P2to444_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src422P3to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src422to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3, typeSrcIsTypeDst *aDst1,           \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src422P3to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src422P3to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src422P3to444_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src422C2to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src422to444<typeSrcIsTypeDst>(                                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src422C2to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src422C2to444P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src422P2to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src422to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src422P2to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src422P2to444P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src422P3to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src422to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src422P3to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src422P3to444P3_For(Pixel##type##C4A);
                                    ...
                                    const mpp::cuda::StreamCtx &aStreamCtx)
{
    ...
    else if (aChromaSubsamplePos == ChromaSubsamplePos::TopLeft)
    {
        switch (aInterpolationMode)
        {
            ...
            {
                using colorTwistSrc = Src420Functor<TupelSize, SrcT, ComputeT, DstT,
                                                    mpp::image::ColorTwist3x3<ComputeT>, ChromaSubsamplePos::TopLeft,
                                                    InterpolationMode::Linear, false, false, GetRoundingMode<DstT>()>;
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src420P2to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src420to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector2<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2, typeSrcIsTypeDst *aDst1,           \
        size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,   \
        InterpolationMode aInterpolationMode, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src420P2to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src420P2to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src420P2to444_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src420P3to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src420to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3, typeSrcIsTypeDst *aDst1,           \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src420P3to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src420P3to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src420P3to444_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src420P2to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src420to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector2<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1, size_t aPitchDst1,                                          \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src420P2to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src420P2to444P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src420P3to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src420to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src420P3to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src420P3to444P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src411P2to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src411to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector2<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2, typeSrcIsTypeDst *aDst1,           \
        size_t aPitchDst1, const Matrix<float> &aTwist, const Size2D &aSize, ChromaSubsamplePos aChromaSubsamplePos,   \
        InterpolationMode aInterpolationMode, const StreamCtx &aStreamCtx);

#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src411P2to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src411P2to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src411P2to444_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src411P3to444_For(typeSrcIsTypeDst)                                              \
    template void InvokeColorTwist3x3Src411to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3, typeSrcIsTypeDst *aDst1,           \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src411P3to444(type)                                                  \
    InstantiateInvokeColorTwist3x3Src411P3to444_For(Pixel##type##C3);                                                  \
    InstantiateInvokeColorTwist3x3Src411P3to444_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src411P2to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src411to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector2<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        Vector1<remove_vector_t<typeSrcIsTypeDst>> *aDst1, size_t aPitchDst1,                                          \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src411P2to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src411P2to444P3_For(Pixel##type##C4A);
...
#pragma region Instantiate
#define InstantiateInvokeColorTwist3x3Src411P3to444P3_For(typeSrcIsTypeDst)                                            \
    template void InvokeColorTwist3x3Src411to444<typeSrcIsTypeDst>(                                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc1, size_t aPitchSrc1,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc2, size_t aPitchSrc2,                                    \
        const Vector1<remove_vector_t<typeSrcIsTypeDst>> *aSrc3, size_t aPitchSrc3,                                    \
...
#define ForAllChannelsWithAlphaInvokeColorTwist3x3Src411P3to444P3(type)                                                \
    InstantiateInvokeColorTwist3x3Src411P3to444P3_For(Pixel##type##C4A);
