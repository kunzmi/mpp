...
template <typename SrcDstT>
void InvokeColorTwist3x4Src422to444(const Vector2<remove_vector_t<SrcDstT>> *aSrc1, size_t aPitchSrc1, SrcDstT *aDst,
                                    size_t aPitchDst, const Matrix3x4<float> &aTwist, const Size2D &aSize,
