...
#define MPPEXPORT_SIMPLECPU64S MPPEXPORT_SIMPLECPU
#include "imageView.h"
...
{
#ifndef _WIN32
extern template class MPPEXPORT_SIMPLECPU ImageView<Pixel64sC1>;
extern template class MPPEXPORT_SIMPLECPU ImageView<Pixel64sC2>;
extern template class MPPEXPORT_SIMPLECPU ImageView<Pixel64sC3>;
extern template class MPPEXPORT_SIMPLECPU ImageView<Pixel64sC4>;
extern template class MPPEXPORT_SIMPLECPU ImageView<Pixel64sC4A>;
#endif

template class ImageView<Pixel64sC1>;
template class ImageView<Pixel64sC2>;
template class ImageView<Pixel64sC3>;
template class ImageView<Pixel64sC4>;
template class ImageView<Pixel64sC4A>;
//
