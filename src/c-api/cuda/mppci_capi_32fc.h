...
extern "C"
{
    ...
    /// <summary>
    /// aDst = abs(aSrc1) (complex magnitude)<para/>
    ...
    /// </summary>
    MPPErrorCode mppciMagnitude_32fc32f_C1(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                           DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                           CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// aDst = abs(aSrc1)^2 (complex magnitude squared)<para/>
    /// If the source image ROI is of size (widthDestination / 2 + 1, heightDestination), the size of a R2C FFT with
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeSqr_32fc32f_C1(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// aDst = log(abs(aSrc1) + aOffset) (logarithm of complex magnitude)<para/>
    /// To avoid -INF in case of 0+0i, an offset is added to the magnitude value.<para/>
    /// If the source image ROI is of size (widthDestination / 2 + 1, heightDestination), the size of a R2C FFT with
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeLog_32fc32f_C1(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, Mpp32f aOffset, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciDotProductBufferSize_32fc_C1(size_t *aBufferSize, MppiSize aSizeROI,
                                                   CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C1(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MSEMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C1M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    MPPErrorCode mppciSumBufferSize_32fc64f_C1(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C1M(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C1(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MeanMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C1M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C1(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C1M(size_t *aBufferSize, MppiSize aSizeROI,
                                                 CPtrMppCudaStreamCtx aStreamCtx);
    ...
    MPPErrorCode mppciReplaceIfFloat_32fc_C1I(DevPtrMpp32fc aSrcDst, size_t aSrcDstStep, MPPCompareOp aCompare,
                                              Mpp32fc aValue, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitude_32fc32f_C2(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                           DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                           CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeSqr_32fc32f_C2(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeLog_32fc32f_C2(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, Mpp32f aOffset, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// BorderType::Constant, the constant value to use must be provided.
    /// </summary>
    MPPErrorCode mppciResizeSqrPixel_32fc_P2RCb(
        ConstDevPtrMpp32fc aSrc1BasePtr, size_t aSrc1Step, ConstDevPtrMpp32fc aSrc2BasePtr, size_t aSrc2Step,
        MppiSize aSrcFullSize, DevPtrMpp32fc aDst1, size_t aDst1Step, DevPtrMpp32fc aDst2, size_t aDst2Step,
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciDotProductBufferSize_32fc_C2(size_t *aBufferSize, MppiSize aSizeROI,
                                                   CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C2(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MSEMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C2M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C2(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C2M(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C2(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MeanMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C2M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C2(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C2M(size_t *aBufferSize, MppiSize aSizeROI,
                                                 CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitude_32fc32f_C3(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                           DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                           CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeSqr_32fc32f_C3(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeLog_32fc32f_C3(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, Mpp32f aOffset, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// For BorderType::Constant, the constant value to use must be provided.
    /// </summary>
    MPPErrorCode mppciWarpAffineBack_32fc_P3RCb(
        ConstDevPtrMpp32fc aSrc1BasePtr, size_t aSrc1Step, ConstDevPtrMpp32fc aSrc2BasePtr, size_t aSrc2Step,
    ...
    /// For BorderType::Constant, the constant value to use must be provided.
    /// </summary>
    MPPErrorCode mppciWarpPerspective_32fc_P3RCb(
        ConstDevPtrMpp32fc aSrc1BasePtr, size_t aSrc1Step, ConstDevPtrMpp32fc aSrc2BasePtr, size_t aSrc2Step,
        ConstDevPtrMpp32fc aSrc3BasePtr, size_t aSrc3Step, MppiSize aSrcFullSize, DevPtrMpp32fc aDst1, size_t aDst1Step,
        DevPtrMpp32fc aDst2, size_t aDst2Step, DevPtrMpp32fc aDst3, size_t aDst3Step, MppiSize aDstSize,
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciDotProductBufferSize_32fc_C3(size_t *aBufferSize, MppiSize aSizeROI,
                                                   CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C3(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MSEMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C3M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C3(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C3M(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C3(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MeanMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C3M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C3(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C3M(size_t *aBufferSize, MppiSize aSizeROI,
                                                 CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitude_32fc32f_C4(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                           DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                           CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeSqr_32fc32f_C4(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// FFTW or CUFFT, then the result corresponds to the full spectrum with 0 frequency in the center.
    /// </summary>
    MPPErrorCode mppciMagnitudeLog_32fc32f_C4(ConstDevPtrMpp32fc aSrc1, size_t aSrc1Step, MppiSize aSizeSrc1,
                                              DevPtrMpp32f aDst, size_t aDstStep, Mpp32f aOffset, MppiSize aSizeROI,
                                              CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// For BorderType::Constant, the constant value to use must be provided.
    /// </summary>
    MPPErrorCode mppciWarpPerspective_32fc_P4R(
        ConstDevPtrMpp32fc aSrc1BasePtr, size_t aSrc1Step, ConstDevPtrMpp32fc aSrc2BasePtr, size_t aSrc2Step,
        ConstDevPtrMpp32fc aSrc3BasePtr, size_t aSrc3Step, ConstDevPtrMpp32fc aSrc4BasePtr, size_t aSrc4Step,
        MppiSize aSrcFullSize, DevPtrMpp32fc aDst1, size_t aDst1Step, DevPtrMpp32fc aDst2, size_t aDst2Step,
        DevPtrMpp32fc aDst3, size_t aDst3Step, DevPtrMpp32fc aDst4, size_t aDst4Step, MppiSize aDstSize,
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciDotProductBufferSize_32fc_C4(size_t *aBufferSize, MppiSize aSizeROI,
                                                   CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C4(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MSEMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMSEBufferSize_32fc_C4M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C4(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// </summary>
    /// <param name="aDst">Used as output type indicator</param>
    MPPErrorCode mppciSumBufferSize_32fc64f_C4M(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C4(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);

    /// <summary>
    /// Returns the required temporary buffer size for MeanMasked.<para/>
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanBufferSize_32fc_C4M(size_t *aBufferSize, MppiSize aSizeROI, CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C4(size_t *aBufferSize, MppiSize aSizeROI,
                                                CPtrMppCudaStreamCtx aStreamCtx);
    ...
    /// Note: the buffer size differs for varying ROI sizes.
    /// </summary>
    MPPErrorCode mppciMeanStdBufferSize_32fc_C4M(size_t *aBufferSize, MppiSize aSizeROI,
                                                 CPtrMppCudaStreamCtx aStreamCtx);
