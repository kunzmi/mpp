...
template <opp::FixedFilter filter, int filterSize, typename filterT> struct FixedInvertedFilterKernel
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 3, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 5, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 7, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 9, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 11, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 13, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::Gauss, 15, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 3, double>
{
...
template <typename filterT> struct FixedInvertedFilterKernel<opp::FixedFilter::PrewittVert, 3, filterT>
{
    MYCONST filterT Values[3][3] = {{1, 0, -1}, {1, 0, -1}, {1, 0, -1}};
    MYCONST filterT Scaling      = 1;
...
template <> struct FixedFilterKernel<opp::FixedFilter::Sharpen, 3, double>
{
    MYCONST double Values[3][3] = {
...
template <typename filterT> struct FixedInvertedFilterKernel<opp::FixedFilter::SobelVert, 3, filterT>
{
    MYCONST filterT Values[3][3] = {{1, 0, -1}, {2, 0, -2}, {1, 0, -1}};
    MYCONST filterT Scaling      = 1;
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 5, double>
{
...
template <typename filterT> struct FixedInvertedFilterKernel<opp::FixedFilter::SobelVert, 5, filterT>
{
    MYCONST filterT Values[5][5] = {{1, 2, 0, -2, -1},   //
                                    {4, 8, 0, -8, -4},   //
                                    {6, 12, 0, -12, -6}, //
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 7, float>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 9, float>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 11, float>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 13, float>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 15, float>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 7, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 9, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 11, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 13, double>
{
...
template <> struct FixedFilterKernel<opp::FixedFilter::LowPass, 15, double>
{
