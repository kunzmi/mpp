...
template <size_t tupelSize, typename SrcT> struct SrcReductionMinMaxIdxFunctor
{
...
#pragma region Constructors
    ...
    DEVICE_CODE SrcReductionMinMaxIdxFunctor(const SrcT *aSrc1, size_t aSrcPitch1) : Src1(aSrc1), SrcPitch1(aSrcPitch1)
    {
    }
#pragma endregion

#pragma region run naive on one pixel
    DEVICE_CODE void operator()(int aPixelX, int aPixelY, SrcT &aDstMin, SrcT &aDstMax,
