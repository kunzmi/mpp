...
#pragma region Constructors
    ...
    SrcReduction2Functor(const SrcT *aSrc1, size_t aSrcPitch1, operation1 aOp1, operation2 aOp2)
        : Src1(aSrc1), SrcPitch1(aSrcPitch1), Op1(aOp1), Op2(aOp2)
    {
    }
#pragma endregion
...
#pragma unroll
        ...
        {
            Op1(tupelSrc1.value[i], aDst1);
            Op2(tupelSrc1.value[i], aDst2);
        }
    }
