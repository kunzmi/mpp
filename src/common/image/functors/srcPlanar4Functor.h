...
{
/// <summary>
/// Computes an output pixel from four single channel planar src arrays -&gt; dst pixel
/// </summary>
...
struct SrcPlanar4Functor : public ImageFunctor<false>
{
...
#pragma region Constructors
    ...
    SrcPlanar4Functor(const SrcPlane *aSrc1, size_t aSrcPitch1, const SrcPlane *aSrc2, size_t aSrcPitch2,
                      const SrcPlane *aSrc3, size_t aSrcPitch3, const SrcPlane *aSrc4, size_t aSrcPitch4, operation aOp)
        : Src1(aSrc1), SrcPitch1(aSrcPitch1), Src2(aSrc2), SrcPitch2(aSrcPitch2), Src3(aSrc3), SrcPitch3(aSrcPitch3),
          Src4(aSrc4), SrcPitch4(aSrcPitch4), Op(aOp)
    {
    }
#pragma endregion
...
#pragma unroll
        for (size_t i = 0; i < tupelSize; i++)
        {
            ...
            tupelSrc.value[i].w = tupelSrc4.value[i].x;
        }
