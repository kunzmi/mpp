...
{
/// <summary>
/// Computes an output pixel from one src array -> dst pixel with float scaling of result
/// </summary>
...
struct SrcScaleFunctor : public ImageFunctor<false>
{
    ...
    SrcScaleFunctor(const SrcT *aSrc1, size_t aSrcPitch1, operation aOp, remove_vector_t<ComputeT> aScaleFactor)
