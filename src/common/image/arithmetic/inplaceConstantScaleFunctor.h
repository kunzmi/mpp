...
{
/// <summary>
/// Computes an output pixel from one srcDst pixel and one constant value -> srcDst pixel inplace with float scaling of
/// result
/// </summary>
...
struct InplaceConstantScaleFunctor
{
    ...
    InplaceConstantScaleFunctor(ComputeType aConstant, operation aOp, float aScaleFactor)
