...
struct SrcDevConstantFunctor
{
    ...
    SrcDevConstantFunctor(SrcType *aSrc1, size_t aSrcPitch1, ComputeType *aConstant, operation aOp)
...
#pragma unroll
        ...
        {
            Op(ComputeType(tupelSrc1.value[i]), _constant, aDst.value[i]);
        }
    }
