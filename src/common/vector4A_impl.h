...
/// </summary>
template <Number T>
DEVICE_CODE bool Vector4A<T>::EqEps(Vector4A aLeft, Vector4A aRight, T aEpsilon)
...
/// </summary>
template <Number T>
Vector4A<byte> Vector4A<T>::CompareEQEps(Vector4A<T> aLeft, Vector4A<T> aRight, T aEpsilon)
    requires NativeFloatingPoint<T> && HostCode<T>
{
    MakeNANandINFValid(aLeft.x, aRight.x);
    MakeNANandINFValid(aLeft.y, aRight.y);
...
/// </summary>
template <Number T>
DEVICE_CODE Vector4A<byte> Vector4A<T>::CompareEQEps(Vector4A<T> aLeft, Vector4A<T> aRight, T aEpsilon)
    requires NativeFloatingPoint<T> && DeviceCode<T>
{
    MakeNANandINFValid(aLeft.x, aRight.x);
    MakeNANandINFValid(aLeft.y, aRight.y);
